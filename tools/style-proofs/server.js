// Zero-dependency static file server for the style-proofs gate.
//
...
//
// Serves the REPO ROOT (not this package) so the built fixtures load the real,
// uncopied artifacts written under tools/style-proofs/fixtures by their
// repo-relative path.
'use strict';
...
const PORT = Number(process.env.STYLE_PROOFS_PORT) || 4791;
...
server.listen(PORT, '127.0.0.1', () => {
  ...
  console.log('style-proofs static server listening on http://127.0.0.1:' + PORT);
});
