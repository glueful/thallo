...
test('the stage + arms the tab after the container and Enter inserts the first match there', async ({
  page,
}) => {
  ...
  await expect(strip).toContainText('Inserting after Container')
