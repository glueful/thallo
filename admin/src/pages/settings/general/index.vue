...
// How the site BEHAVES. How it looks — theme, colours, design, logos — is Site › Appearance, which
// shares this endpoint; each page edits and saves only its own keys (useSettingsForm).
        ...
        <template v-else>
          ...
          <div class="grid gap-6 lg:grid-cols-3 pb-5">
            ...
            <div class="space-y-6 lg:col-span-2">
              <!-- How the site LOOKS — theme, colours, design, logos — is Site › Appearance. -->
              <UAlert
                color="neutral"
                variant="subtle"
