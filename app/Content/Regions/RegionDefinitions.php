...
final class RegionDefinitions
{
    ...
    public const PALETTES = [
        // `mini-cart` and `wishlist-link` are commerce-owned (thallo.commerce): the picker
        // only offers them while the capability is on (they need the registered block-type
        // definitions), and a stored one renders through the missing-template fallback while
        // the capability is off — the palette entries themselves are inert without commerce.
        'header' => [
