...
\restrict j4JIttt0ejMr6TBgKK5qaLCDWqMg2TbAqJr7AaV5ZIlIBIwgSx5fiIAkj7iCZ4A
...
DROP INDEX IF EXISTS public.subscription_checkout_subject_guards_state_index;
DROP INDEX IF EXISTS public.subscription_checkout_originations_subject_key_live_index;
DROP INDEX IF EXISTS public.subscription_checkout_originations_status_index;
...
DROP INDEX IF EXISTS public.provider_events_status_index;
DROP INDEX IF EXISTS public.provider_events_gateway_logical_event_key_index;
DROP INDEX IF EXISTS public.provider_events_dispatch_status_index;
...
DROP INDEX IF EXISTS public.payvia_transfers_tenant_uuid_index;
DROP INDEX IF EXISTS public.payments_user_uuid_index;
DROP INDEX IF EXISTS public.payments_tenant_uuid_index;
DROP INDEX IF EXISTS public.payments_payable_type_payable_id_index;
DROP INDEX IF EXISTS public.payments_gateway_transaction_id_index;
DROP INDEX IF EXISTS public.payments_gateway_index;
DROP INDEX IF EXISTS public.payment_intents_tenant_uuid_index;
DROP INDEX IF EXISTS public.payment_intents_tenant_uuid_gateway_reference_unique;
DROP INDEX IF EXISTS public.payment_intents_reference_index;
DROP INDEX IF EXISTS public.payment_intents_payable_type_payable_id_status_index;
DROP INDEX IF EXISTS public.payment_intents_gateway_index;
...
DROP INDEX IF EXISTS public.invoices_user_uuid_index;
DROP INDEX IF EXISTS public.invoices_tenant_uuid_index;
DROP INDEX IF EXISTS public.invoices_status_index;
DROP INDEX IF EXISTS public.invoices_payable_type_payable_id_index;
DROP INDEX IF EXISTS public.invoices_due_at_index;
DROP INDEX IF EXISTS public.invoices_billing_plan_uuid_index;
...
DROP INDEX IF EXISTS public.idx_provider_events_dispatch;
...
DROP INDEX IF EXISTS public.gateway_subscriptions_tenant_uuid_index;
DROP INDEX IF EXISTS public.gateway_subscriptions_gateway_status_index;
DROP INDEX IF EXISTS public.gateway_subscriptions_billing_plan_uuid_index;
...
DROP INDEX IF EXISTS public.commerce_wishlist_items_tenant_user_position_index;
DROP INDEX IF EXISTS public.commerce_variants_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_variants_product_uuid_index;
DROP INDEX IF EXISTS public.commerce_tax_rates_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_tax_rates_tenant_uuid_country_index;
DROP INDEX IF EXISTS public.commerce_tags_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_stock_movements_tenant_uuid_variant_uuid_index;
DROP INDEX IF EXISTS public.commerce_shipping_zones_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_shipping_zone_locations_zone_uuid_index;
DROP INDEX IF EXISTS public.commerce_shipping_methods_zone_uuid_index;
DROP INDEX IF EXISTS public.commerce_shipping_classes_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_sellers_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_seller_webhook_secrets_endpoint_rel_index;
DROP INDEX IF EXISTS public.commerce_seller_webhook_events_seller_created_index;
DROP INDEX IF EXISTS public.commerce_seller_webhook_endpoints_seller_status_index;
DROP INDEX IF EXISTS public.commerce_seller_webhook_endpoint_events_endpoint_created_index;
DROP INDEX IF EXISTS public.commerce_seller_webhook_deliveries_status_next_index;
DROP INDEX IF EXISTS public.commerce_seller_webhook_deliveries_status_claim_index;
DROP INDEX IF EXISTS public.commerce_seller_webhook_deliveries_event_index;
DROP INDEX IF EXISTS public.commerce_seller_webhook_deliveries_endpoint_status_index;
DROP INDEX IF EXISTS public.commerce_seller_reserves_status_release_index;
DROP INDEX IF EXISTS public.commerce_seller_reserves_fifo_index;
DROP INDEX IF EXISTS public.commerce_seller_orders_order_uuid_index;
DROP INDEX IF EXISTS public.commerce_seller_orders_confirmed_listing_index;
DROP INDEX IF EXISTS public.commerce_seller_memberships_tenant_uuid_user_uuid_index;
DROP INDEX IF EXISTS public.commerce_seller_memberships_seller_uuid_status_role_index;
DROP INDEX IF EXISTS public.commerce_seller_lifecycle_events_seller_created_index;
DROP INDEX IF EXISTS public.commerce_seller_api_keys_seller_status_index;
DROP INDEX IF EXISTS public.commerce_seller_api_key_events_seller_created_index;
DROP INDEX IF EXISTS public.commerce_seller_api_key_events_action_created_index;
DROP INDEX IF EXISTS public.commerce_seller_api_key_credentials_lineage_rel_index;
DROP INDEX IF EXISTS public.commerce_seller_api_key_credentials_lineage_index;
DROP INDEX IF EXISTS public.commerce_reviews_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_reviews_product_uuid_index;
DROP INDEX IF EXISTS public.commerce_reserve_events_subject_created_index;
DROP INDEX IF EXISTS public.commerce_refunds_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_refunds_tenant_uuid_completed_at_index;
DROP INDEX IF EXISTS public.commerce_refunds_order_uuid_index;
DROP INDEX IF EXISTS public.commerce_refund_lines_refund_uuid_index;
DROP INDEX IF EXISTS public.commerce_products_tenant_uuid_seller_uuid_index;
DROP INDEX IF EXISTS public.commerce_products_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_products_status_index;
DROP INDEX IF EXISTS public.commerce_product_tags_tag_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_tags_product_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_media_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_media_product_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_children_product_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_children_child_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_categories_product_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_categories_category_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_attributes_product_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_addons_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_product_addons_product_uuid_index;
DROP INDEX IF EXISTS public.commerce_payouts_tenant_uuid_seller_uuid_currency_index;
DROP INDEX IF EXISTS public.commerce_payouts_status_next_reconcile_index;
DROP INDEX IF EXISTS public.commerce_payouts_status_next_attempt_index;
DROP INDEX IF EXISTS public.commerce_payout_accounts_tenant_seller_index;
DROP INDEX IF EXISTS public.commerce_payment_links_order_status_index;
DROP INDEX IF EXISTS public.commerce_payment_links_issued_session_index;
DROP INDEX IF EXISTS public.commerce_orders_tenant_uuid_user_uuid_index;
DROP INDEX IF EXISTS public.commerce_orders_tenant_uuid_status_index;
DROP INDEX IF EXISTS public.commerce_orders_tenant_uuid_placed_at_index;
DROP INDEX IF EXISTS public.commerce_orders_tenant_uuid_created_at_index;
DROP INDEX IF EXISTS public.commerce_order_lines_order_uuid_seller_uuid_index;
DROP INDEX IF EXISTS public.commerce_order_lines_order_uuid_index;
DROP INDEX IF EXISTS public.commerce_order_events_order_uuid_index;
DROP INDEX IF EXISTS public.commerce_marketplace_ledger_reserve_uuid_index;
DROP INDEX IF EXISTS public.commerce_marketplace_ledger_refund_uuid_index;
DROP INDEX IF EXISTS public.commerce_marketplace_ledger_payout_uuid_index;
DROP INDEX IF EXISTS public.commerce_marketplace_ledger_order_uuid_index;
DROP INDEX IF EXISTS public.commerce_marketplace_ledger_chargeback_uuid_index;
DROP INDEX IF EXISTS public.commerce_ledger_account_kind_seller_currency_index;
DROP INDEX IF EXISTS public.commerce_ledger_account_key_currency_index;
DROP INDEX IF EXISTS public.commerce_downloads_variant_uuid_index;
DROP INDEX IF EXISTS public.commerce_downloads_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_downloads_blob_uuid_index;
DROP INDEX IF EXISTS public.commerce_download_grants_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_download_grants_order_uuid_index;
DROP INDEX IF EXISTS public.commerce_download_grants_blob_uuid_index;
DROP INDEX IF EXISTS public.commerce_customer_addresses_tenant_uuid_user_uuid_index;
DROP INDEX IF EXISTS public.commerce_commission_events_subject_created_index;
DROP INDEX IF EXISTS public.commerce_chargebacks_tenant_status_index;
DROP INDEX IF EXISTS public.commerce_chargebacks_tenant_order_index;
DROP INDEX IF EXISTS public.commerce_chargeback_lines_tenant_seller_index;
DROP INDEX IF EXISTS public.commerce_categories_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_categories_parent_uuid_index;
DROP INDEX IF EXISTS public.commerce_carts_tenant_uuid_user_uuid_index;
DROP INDEX IF EXISTS public.commerce_attributes_tenant_uuid_index;
DROP INDEX IF EXISTS public.commerce_attribute_values_attribute_uuid_index;
...
DROP INDEX IF EXISTS public.billing_plans_tenant_uuid_index;
...
ALTER TABLE IF EXISTS ONLY public.commerce_download_grants DROP CONSTRAINT IF EXISTS uniq_grant_token_hash;
ALTER TABLE IF EXISTS ONLY public.commerce_download_grants DROP CONSTRAINT IF EXISTS uniq_grant_order_download;
...
ALTER TABLE IF EXISTS ONLY public.subscription_checkout_subject_guards DROP CONSTRAINT IF EXISTS subscription_checkout_subject_guards_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.subscription_checkout_subject_guards DROP CONSTRAINT IF EXISTS subscription_checkout_subject_guards_tenant_uuid_subject_key_un;
ALTER TABLE IF EXISTS ONLY public.subscription_checkout_subject_guards DROP CONSTRAINT IF EXISTS subscription_checkout_subject_guards_pkey;
ALTER TABLE IF EXISTS ONLY public.subscription_checkout_originations DROP CONSTRAINT IF EXISTS subscription_checkout_originations_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.subscription_checkout_originations DROP CONSTRAINT IF EXISTS subscription_checkout_originations_tenant_uuid_idempotency_key_;
ALTER TABLE IF EXISTS ONLY public.subscription_checkout_originations DROP CONSTRAINT IF EXISTS subscription_checkout_originations_pkey;
ALTER TABLE IF EXISTS ONLY public.subscription_checkout_originations DROP CONSTRAINT IF EXISTS subscription_checkout_originations_gateway_provider_subscriptio;
ALTER TABLE IF EXISTS ONLY public.subscription_checkout_originations DROP CONSTRAINT IF EXISTS subscription_checkout_originations_gateway_checkout_reference_u;
...
ALTER TABLE IF EXISTS ONLY public.provider_events DROP CONSTRAINT IF EXISTS provider_events_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.provider_events DROP CONSTRAINT IF EXISTS provider_events_pkey;
ALTER TABLE IF EXISTS ONLY public.provider_events DROP CONSTRAINT IF EXISTS provider_events_gateway_delivery_key_unique;
...
ALTER TABLE IF EXISTS ONLY public.payvia_transfers DROP CONSTRAINT IF EXISTS payvia_transfers_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.payvia_transfers DROP CONSTRAINT IF EXISTS payvia_transfers_tenant_uuid_gateway_idempotency_key_unique;
ALTER TABLE IF EXISTS ONLY public.payvia_transfers DROP CONSTRAINT IF EXISTS payvia_transfers_pkey;
ALTER TABLE IF EXISTS ONLY public.payvia_transfers DROP CONSTRAINT IF EXISTS payvia_transfers_gateway_provider_reference_unique;
ALTER TABLE IF EXISTS ONLY public.payvia_transfers DROP CONSTRAINT IF EXISTS payvia_transfers_gateway_provider_ref_unique;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_reference_unique;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_pkey;
ALTER TABLE IF EXISTS ONLY public.payment_intents DROP CONSTRAINT IF EXISTS payment_intents_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.payment_intents DROP CONSTRAINT IF EXISTS payment_intents_tenant_uuid_idempotency_key_unique;
...
ALTER TABLE IF EXISTS ONLY public.invoices DROP CONSTRAINT IF EXISTS invoices_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.invoices DROP CONSTRAINT IF EXISTS invoices_tenant_uuid_number_unique;
...
ALTER TABLE IF EXISTS ONLY public.gateway_subscriptions DROP CONSTRAINT IF EXISTS gateway_subscriptions_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.gateway_subscriptions DROP CONSTRAINT IF EXISTS gateway_subscriptions_pkey;
ALTER TABLE IF EXISTS ONLY public.gateway_subscriptions DROP CONSTRAINT IF EXISTS gateway_subscriptions_gateway_gateway_subscription_id_unique;
...
ALTER TABLE IF EXISTS ONLY public.commerce_wishlists DROP CONSTRAINT IF EXISTS commerce_wishlists_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_wishlists DROP CONSTRAINT IF EXISTS commerce_wishlists_tenant_user_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_wishlists DROP CONSTRAINT IF EXISTS commerce_wishlists_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_wishlist_items DROP CONSTRAINT IF EXISTS commerce_wishlist_items_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_wishlist_items DROP CONSTRAINT IF EXISTS commerce_wishlist_items_tenant_user_product_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_wishlist_items DROP CONSTRAINT IF EXISTS commerce_wishlist_items_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_variants DROP CONSTRAINT IF EXISTS commerce_variants_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_variants DROP CONSTRAINT IF EXISTS commerce_variants_tenant_uuid_sku_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_variants DROP CONSTRAINT IF EXISTS commerce_variants_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_tax_rates DROP CONSTRAINT IF EXISTS commerce_tax_rates_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_tax_rates DROP CONSTRAINT IF EXISTS commerce_tax_rates_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_tags DROP CONSTRAINT IF EXISTS commerce_tags_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_tags DROP CONSTRAINT IF EXISTS commerce_tags_tenant_uuid_slug_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_tags DROP CONSTRAINT IF EXISTS commerce_tags_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_stock DROP CONSTRAINT IF EXISTS commerce_stock_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_stock DROP CONSTRAINT IF EXISTS commerce_stock_tenant_uuid_variant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_stock DROP CONSTRAINT IF EXISTS commerce_stock_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_stock_movements DROP CONSTRAINT IF EXISTS commerce_stock_movements_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_stock_movements DROP CONSTRAINT IF EXISTS commerce_stock_movements_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_zones DROP CONSTRAINT IF EXISTS commerce_shipping_zones_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_zones DROP CONSTRAINT IF EXISTS commerce_shipping_zones_tenant_uuid_name_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_zones DROP CONSTRAINT IF EXISTS commerce_shipping_zones_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_zone_locations DROP CONSTRAINT IF EXISTS commerce_shipping_zone_locations_zone_uuid_kind_value_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_zone_locations DROP CONSTRAINT IF EXISTS commerce_shipping_zone_locations_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_methods DROP CONSTRAINT IF EXISTS commerce_shipping_methods_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_methods DROP CONSTRAINT IF EXISTS commerce_shipping_methods_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_classes DROP CONSTRAINT IF EXISTS commerce_shipping_classes_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_classes DROP CONSTRAINT IF EXISTS commerce_shipping_classes_tenant_uuid_slug_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_shipping_classes DROP CONSTRAINT IF EXISTS commerce_shipping_classes_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_sequences DROP CONSTRAINT IF EXISTS commerce_sequences_tenant_uuid_name_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_sequences DROP CONSTRAINT IF EXISTS commerce_sequences_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_sellers DROP CONSTRAINT IF EXISTS commerce_sellers_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_sellers DROP CONSTRAINT IF EXISTS commerce_sellers_tenant_uuid_slug_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_sellers DROP CONSTRAINT IF EXISTS commerce_sellers_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_webhook_secrets DROP CONSTRAINT IF EXISTS commerce_seller_webhook_secrets_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_webhook_secrets DROP CONSTRAINT IF EXISTS commerce_seller_webhook_secrets_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_webhook_events DROP CONSTRAINT IF EXISTS commerce_seller_webhook_events_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_webhook_events DROP CONSTRAINT IF EXISTS commerce_seller_webhook_events_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_webhook_endpoints DROP CONSTRAINT IF EXISTS commerce_seller_webhook_endpoints_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_webhook_endpoints DROP CONSTRAINT IF EXISTS commerce_seller_webhook_endpoints_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_webhook_endpoint_events DROP CONSTRAINT IF EXISTS commerce_seller_webhook_endpoint_events_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_webhook_endpoint_events DROP CONSTRAINT IF EXISTS commerce_seller_webhook_endpoint_events_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_webhook_deliveries DROP CONSTRAINT IF EXISTS commerce_seller_webhook_deliveries_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_reserves DROP CONSTRAINT IF EXISTS commerce_seller_reserves_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_reserves DROP CONSTRAINT IF EXISTS commerce_seller_reserves_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_reserves DROP CONSTRAINT IF EXISTS commerce_seller_reserves_order_seller_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_reserves DROP CONSTRAINT IF EXISTS commerce_seller_reserves_idempotency_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_payout_accounts DROP CONSTRAINT IF EXISTS commerce_seller_payout_accounts_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_orders DROP CONSTRAINT IF EXISTS commerce_seller_orders_tenant_uuid_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_orders DROP CONSTRAINT IF EXISTS commerce_seller_orders_tenant_uuid_seller_reference_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_orders DROP CONSTRAINT IF EXISTS commerce_seller_orders_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_orders DROP CONSTRAINT IF EXISTS commerce_seller_orders_order_uuid_seller_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_orders DROP CONSTRAINT IF EXISTS commerce_seller_orders_order_uuid_partition_number_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_memberships DROP CONSTRAINT IF EXISTS commerce_seller_memberships_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_memberships DROP CONSTRAINT IF EXISTS commerce_seller_memberships_seller_uuid_user_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_memberships DROP CONSTRAINT IF EXISTS commerce_seller_memberships_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_lifecycle_events DROP CONSTRAINT IF EXISTS commerce_seller_lifecycle_events_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_lifecycle_events DROP CONSTRAINT IF EXISTS commerce_seller_lifecycle_events_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_keys DROP CONSTRAINT IF EXISTS commerce_seller_api_keys_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_keys DROP CONSTRAINT IF EXISTS commerce_seller_api_keys_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_keys DROP CONSTRAINT IF EXISTS commerce_seller_api_keys_current_credential_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_key_events DROP CONSTRAINT IF EXISTS commerce_seller_api_key_events_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_key_events DROP CONSTRAINT IF EXISTS commerce_seller_api_key_events_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_key_events DROP CONSTRAINT IF EXISTS commerce_seller_api_key_events_dedupe_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_key_credentials DROP CONSTRAINT IF EXISTS commerce_seller_api_key_credentials_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_key_credentials DROP CONSTRAINT IF EXISTS commerce_seller_api_key_credentials_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_key_credentials DROP CONSTRAINT IF EXISTS commerce_seller_api_key_credentials_lineage_generation_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_api_key_credentials DROP CONSTRAINT IF EXISTS commerce_seller_api_key_credentials_framework_key_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_reviews DROP CONSTRAINT IF EXISTS commerce_reviews_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_reviews DROP CONSTRAINT IF EXISTS commerce_reviews_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_reserve_policy_events DROP CONSTRAINT IF EXISTS commerce_reserve_policy_events_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_reserve_policy_events DROP CONSTRAINT IF EXISTS commerce_reserve_policy_events_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_refunds DROP CONSTRAINT IF EXISTS commerce_refunds_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_refunds DROP CONSTRAINT IF EXISTS commerce_refunds_tenant_uuid_idempotency_key_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_refunds DROP CONSTRAINT IF EXISTS commerce_refunds_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_refund_lines DROP CONSTRAINT IF EXISTS commerce_refund_lines_refund_uuid_order_line_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_refund_lines DROP CONSTRAINT IF EXISTS commerce_refund_lines_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_products DROP CONSTRAINT IF EXISTS commerce_products_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_products DROP CONSTRAINT IF EXISTS commerce_products_tenant_uuid_slug_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_products DROP CONSTRAINT IF EXISTS commerce_products_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_product_tags DROP CONSTRAINT IF EXISTS commerce_product_tags_product_uuid_tag_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_product_tags DROP CONSTRAINT IF EXISTS commerce_product_tags_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_product_media DROP CONSTRAINT IF EXISTS commerce_product_media_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_product_media DROP CONSTRAINT IF EXISTS commerce_product_media_product_uuid_blob_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_product_media DROP CONSTRAINT IF EXISTS commerce_product_media_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_product_children DROP CONSTRAINT IF EXISTS commerce_product_children_product_uuid_child_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_product_children DROP CONSTRAINT IF EXISTS commerce_product_children_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_product_categories DROP CONSTRAINT IF EXISTS commerce_product_categories_product_uuid_category_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_product_categories DROP CONSTRAINT IF EXISTS commerce_product_categories_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_product_attributes DROP CONSTRAINT IF EXISTS commerce_product_attributes_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_product_attributes DROP CONSTRAINT IF EXISTS commerce_product_attributes_product_uuid_attribute_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_product_attributes DROP CONSTRAINT IF EXISTS commerce_product_attributes_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_product_addons DROP CONSTRAINT IF EXISTS commerce_product_addons_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_product_addons DROP CONSTRAINT IF EXISTS commerce_product_addons_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_payouts DROP CONSTRAINT IF EXISTS commerce_payouts_tenant_uuid_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_payouts DROP CONSTRAINT IF EXISTS commerce_payouts_tenant_uuid_idempotency_key_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_payouts DROP CONSTRAINT IF EXISTS commerce_payouts_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_payout_accounts DROP CONSTRAINT IF EXISTS commerce_payout_accounts_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_seller_payout_accounts DROP CONSTRAINT IF EXISTS commerce_payout_accounts_tenant_seller_provider_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_payment_links DROP CONSTRAINT IF EXISTS commerce_payment_links_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_payment_links DROP CONSTRAINT IF EXISTS commerce_payment_links_tenant_token_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_payment_links DROP CONSTRAINT IF EXISTS commerce_payment_links_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_orders DROP CONSTRAINT IF EXISTS commerce_orders_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_orders DROP CONSTRAINT IF EXISTS commerce_orders_tenant_uuid_order_number_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_orders DROP CONSTRAINT IF EXISTS commerce_orders_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_order_lines DROP CONSTRAINT IF EXISTS commerce_order_lines_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_order_lines DROP CONSTRAINT IF EXISTS commerce_order_lines_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_order_events DROP CONSTRAINT IF EXISTS commerce_order_events_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_order_events DROP CONSTRAINT IF EXISTS commerce_order_events_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_order_draft_attempts DROP CONSTRAINT IF EXISTS commerce_order_draft_attempts_tenant_uuid_idempotency_key_uniqu;
ALTER TABLE IF EXISTS ONLY public.commerce_order_draft_attempts DROP CONSTRAINT IF EXISTS commerce_order_draft_attempts_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_marketplace_settings DROP CONSTRAINT IF EXISTS commerce_marketplace_settings_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_marketplace_settings DROP CONSTRAINT IF EXISTS commerce_marketplace_settings_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_marketplace_settings DROP CONSTRAINT IF EXISTS commerce_marketplace_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_marketplace_ledger DROP CONSTRAINT IF EXISTS commerce_marketplace_ledger_tenant_uuid_idempotency_key_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_marketplace_ledger DROP CONSTRAINT IF EXISTS commerce_marketplace_ledger_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_ledger_account_locks DROP CONSTRAINT IF EXISTS commerce_ledger_account_locks_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_ledger_account_locks DROP CONSTRAINT IF EXISTS commerce_ledger_account_locks_key_currency_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_downloads DROP CONSTRAINT IF EXISTS commerce_downloads_variant_uuid_blob_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_downloads DROP CONSTRAINT IF EXISTS commerce_downloads_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_downloads DROP CONSTRAINT IF EXISTS commerce_downloads_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_download_grants DROP CONSTRAINT IF EXISTS commerce_download_grants_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_download_grants DROP CONSTRAINT IF EXISTS commerce_download_grants_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_discounts DROP CONSTRAINT IF EXISTS commerce_discounts_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_discounts DROP CONSTRAINT IF EXISTS commerce_discounts_tenant_uuid_code_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_discounts DROP CONSTRAINT IF EXISTS commerce_discounts_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_discount_redemptions DROP CONSTRAINT IF EXISTS commerce_discount_redemptions_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_discount_redemptions DROP CONSTRAINT IF EXISTS commerce_discount_redemptions_tenant_uuid_discount_uuid_buyer_k;
ALTER TABLE IF EXISTS ONLY public.commerce_discount_redemptions DROP CONSTRAINT IF EXISTS commerce_discount_redemptions_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_customer_addresses DROP CONSTRAINT IF EXISTS commerce_customer_addresses_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_customer_addresses DROP CONSTRAINT IF EXISTS commerce_customer_addresses_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_customer_address_books DROP CONSTRAINT IF EXISTS commerce_customer_address_books_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_customer_address_books DROP CONSTRAINT IF EXISTS commerce_customer_address_books_tenant_uuid_user_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_customer_address_books DROP CONSTRAINT IF EXISTS commerce_customer_address_books_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_commission_policy_events DROP CONSTRAINT IF EXISTS commerce_commission_policy_events_tenant_uuid_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_commission_policy_events DROP CONSTRAINT IF EXISTS commerce_commission_policy_events_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_chargebacks DROP CONSTRAINT IF EXISTS commerce_chargebacks_provider_event_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_chargebacks DROP CONSTRAINT IF EXISTS commerce_chargebacks_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_chargeback_lines DROP CONSTRAINT IF EXISTS commerce_chargeback_lines_tenant_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_chargeback_lines DROP CONSTRAINT IF EXISTS commerce_chargeback_lines_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_chargeback_lines DROP CONSTRAINT IF EXISTS commerce_chargeback_lines_chargeback_order_line_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_categories DROP CONSTRAINT IF EXISTS commerce_categories_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_categories DROP CONSTRAINT IF EXISTS commerce_categories_tenant_uuid_slug_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_categories DROP CONSTRAINT IF EXISTS commerce_categories_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_carts DROP CONSTRAINT IF EXISTS commerce_carts_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_carts DROP CONSTRAINT IF EXISTS commerce_carts_tenant_uuid_token_hash_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_carts DROP CONSTRAINT IF EXISTS commerce_carts_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_cart_lines DROP CONSTRAINT IF EXISTS commerce_cart_lines_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_cart_lines DROP CONSTRAINT IF EXISTS commerce_cart_lines_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_cart_lines DROP CONSTRAINT IF EXISTS commerce_cart_lines_cart_uuid_variant_uuid_addons_hash_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_attributes DROP CONSTRAINT IF EXISTS commerce_attributes_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_attributes DROP CONSTRAINT IF EXISTS commerce_attributes_tenant_uuid_slug_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_attributes DROP CONSTRAINT IF EXISTS commerce_attributes_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_attribute_values DROP CONSTRAINT IF EXISTS commerce_attribute_values_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.commerce_attribute_values DROP CONSTRAINT IF EXISTS commerce_attribute_values_pkey;
ALTER TABLE IF EXISTS ONLY public.commerce_attribute_values DROP CONSTRAINT IF EXISTS commerce_attribute_values_attribute_uuid_slug_unique;
...
ALTER TABLE IF EXISTS ONLY public.billing_plans DROP CONSTRAINT IF EXISTS billing_plans_uuid_unique;
ALTER TABLE IF EXISTS ONLY public.billing_plans DROP CONSTRAINT IF EXISTS billing_plans_tenant_uuid_gateway_name_unique;
...
ALTER TABLE IF EXISTS public.subscription_checkout_subject_guards ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.subscription_checkout_originations ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.provider_events ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.payvia_transfers ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.gateway_subscriptions ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.commerce_wishlists ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_wishlist_items ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_variants ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_tax_rates ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_tags ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_stock_movements ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_stock ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_shipping_zones ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_shipping_zone_locations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_shipping_methods ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_shipping_classes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_sequences ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_sellers ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_webhook_secrets ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_webhook_events ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_webhook_endpoints ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_webhook_endpoint_events ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_webhook_deliveries ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_reserves ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_payout_accounts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_orders ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_memberships ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_lifecycle_events ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_api_keys ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_api_key_events ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_seller_api_key_credentials ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_reviews ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_reserve_policy_events ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_refunds ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_refund_lines ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_products ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_product_tags ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_product_media ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_product_children ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_product_categories ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_product_attributes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_product_addons ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_payouts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_payment_links ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_orders ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_order_lines ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_order_events ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_order_draft_attempts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_marketplace_settings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_marketplace_ledger ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_ledger_account_locks ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_downloads ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_download_grants ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_discounts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_discount_redemptions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_customer_addresses ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_customer_address_books ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_commission_policy_events ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_chargebacks ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_chargeback_lines ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_categories ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_carts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_cart_lines ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_attributes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.commerce_attribute_values ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.subscription_checkout_subject_guards_id_seq;
DROP TABLE IF EXISTS public.subscription_checkout_subject_guards;
DROP SEQUENCE IF EXISTS public.subscription_checkout_originations_id_seq;
DROP TABLE IF EXISTS public.subscription_checkout_originations;
...
DROP SEQUENCE IF EXISTS public.payvia_transfers_id_seq;
DROP TABLE IF EXISTS public.payvia_transfers;
...
DROP SEQUENCE IF EXISTS public.gateway_subscriptions_id_seq;
DROP TABLE IF EXISTS public.gateway_subscriptions;
...
DROP SEQUENCE IF EXISTS public.commerce_wishlists_id_seq;
DROP TABLE IF EXISTS public.commerce_wishlists;
DROP SEQUENCE IF EXISTS public.commerce_wishlist_items_id_seq;
DROP TABLE IF EXISTS public.commerce_wishlist_items;
DROP SEQUENCE IF EXISTS public.commerce_variants_id_seq;
DROP TABLE IF EXISTS public.commerce_variants;
DROP SEQUENCE IF EXISTS public.commerce_tax_rates_id_seq;
DROP TABLE IF EXISTS public.commerce_tax_rates;
DROP SEQUENCE IF EXISTS public.commerce_tags_id_seq;
DROP TABLE IF EXISTS public.commerce_tags;
DROP SEQUENCE IF EXISTS public.commerce_stock_movements_id_seq;
DROP TABLE IF EXISTS public.commerce_stock_movements;
DROP SEQUENCE IF EXISTS public.commerce_stock_id_seq;
DROP TABLE IF EXISTS public.commerce_stock;
DROP SEQUENCE IF EXISTS public.commerce_shipping_zones_id_seq;
DROP TABLE IF EXISTS public.commerce_shipping_zones;
DROP SEQUENCE IF EXISTS public.commerce_shipping_zone_locations_id_seq;
DROP TABLE IF EXISTS public.commerce_shipping_zone_locations;
DROP SEQUENCE IF EXISTS public.commerce_shipping_methods_id_seq;
DROP TABLE IF EXISTS public.commerce_shipping_methods;
DROP SEQUENCE IF EXISTS public.commerce_shipping_classes_id_seq;
DROP TABLE IF EXISTS public.commerce_shipping_classes;
DROP SEQUENCE IF EXISTS public.commerce_sequences_id_seq;
DROP TABLE IF EXISTS public.commerce_sequences;
DROP SEQUENCE IF EXISTS public.commerce_sellers_id_seq;
DROP TABLE IF EXISTS public.commerce_sellers;
DROP SEQUENCE IF EXISTS public.commerce_seller_webhook_secrets_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_webhook_secrets;
DROP SEQUENCE IF EXISTS public.commerce_seller_webhook_events_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_webhook_events;
DROP SEQUENCE IF EXISTS public.commerce_seller_webhook_endpoints_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_webhook_endpoints;
DROP SEQUENCE IF EXISTS public.commerce_seller_webhook_endpoint_events_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_webhook_endpoint_events;
DROP SEQUENCE IF EXISTS public.commerce_seller_webhook_deliveries_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_webhook_deliveries;
DROP SEQUENCE IF EXISTS public.commerce_seller_reserves_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_reserves;
DROP SEQUENCE IF EXISTS public.commerce_seller_payout_accounts_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_payout_accounts;
DROP SEQUENCE IF EXISTS public.commerce_seller_orders_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_orders;
DROP SEQUENCE IF EXISTS public.commerce_seller_memberships_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_memberships;
DROP SEQUENCE IF EXISTS public.commerce_seller_lifecycle_events_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_lifecycle_events;
DROP SEQUENCE IF EXISTS public.commerce_seller_api_keys_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_api_keys;
DROP SEQUENCE IF EXISTS public.commerce_seller_api_key_events_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_api_key_events;
DROP SEQUENCE IF EXISTS public.commerce_seller_api_key_credentials_id_seq;
DROP TABLE IF EXISTS public.commerce_seller_api_key_credentials;
DROP SEQUENCE IF EXISTS public.commerce_reviews_id_seq;
DROP TABLE IF EXISTS public.commerce_reviews;
DROP SEQUENCE IF EXISTS public.commerce_reserve_policy_events_id_seq;
DROP TABLE IF EXISTS public.commerce_reserve_policy_events;
DROP SEQUENCE IF EXISTS public.commerce_refunds_id_seq;
DROP TABLE IF EXISTS public.commerce_refunds;
DROP SEQUENCE IF EXISTS public.commerce_refund_lines_id_seq;
DROP TABLE IF EXISTS public.commerce_refund_lines;
DROP SEQUENCE IF EXISTS public.commerce_products_id_seq;
DROP TABLE IF EXISTS public.commerce_products;
DROP SEQUENCE IF EXISTS public.commerce_product_tags_id_seq;
DROP TABLE IF EXISTS public.commerce_product_tags;
DROP SEQUENCE IF EXISTS public.commerce_product_media_id_seq;
DROP TABLE IF EXISTS public.commerce_product_media;
DROP SEQUENCE IF EXISTS public.commerce_product_children_id_seq;
DROP TABLE IF EXISTS public.commerce_product_children;
DROP SEQUENCE IF EXISTS public.commerce_product_categories_id_seq;
DROP TABLE IF EXISTS public.commerce_product_categories;
DROP SEQUENCE IF EXISTS public.commerce_product_attributes_id_seq;
DROP TABLE IF EXISTS public.commerce_product_attributes;
DROP SEQUENCE IF EXISTS public.commerce_product_addons_id_seq;
DROP TABLE IF EXISTS public.commerce_product_addons;
DROP SEQUENCE IF EXISTS public.commerce_payouts_id_seq;
DROP TABLE IF EXISTS public.commerce_payouts;
DROP SEQUENCE IF EXISTS public.commerce_payment_links_id_seq;
DROP TABLE IF EXISTS public.commerce_payment_links;
DROP SEQUENCE IF EXISTS public.commerce_orders_id_seq;
DROP TABLE IF EXISTS public.commerce_orders;
DROP SEQUENCE IF EXISTS public.commerce_order_lines_id_seq;
DROP TABLE IF EXISTS public.commerce_order_lines;
DROP SEQUENCE IF EXISTS public.commerce_order_events_id_seq;
DROP TABLE IF EXISTS public.commerce_order_events;
DROP SEQUENCE IF EXISTS public.commerce_order_draft_attempts_id_seq;
DROP TABLE IF EXISTS public.commerce_order_draft_attempts;
DROP SEQUENCE IF EXISTS public.commerce_marketplace_settings_id_seq;
DROP TABLE IF EXISTS public.commerce_marketplace_settings;
DROP SEQUENCE IF EXISTS public.commerce_marketplace_ledger_id_seq;
DROP TABLE IF EXISTS public.commerce_marketplace_ledger;
DROP SEQUENCE IF EXISTS public.commerce_ledger_account_locks_id_seq;
DROP TABLE IF EXISTS public.commerce_ledger_account_locks;
DROP SEQUENCE IF EXISTS public.commerce_downloads_id_seq;
DROP TABLE IF EXISTS public.commerce_downloads;
DROP SEQUENCE IF EXISTS public.commerce_download_grants_id_seq;
DROP TABLE IF EXISTS public.commerce_download_grants;
DROP SEQUENCE IF EXISTS public.commerce_discounts_id_seq;
DROP TABLE IF EXISTS public.commerce_discounts;
DROP SEQUENCE IF EXISTS public.commerce_discount_redemptions_id_seq;
DROP TABLE IF EXISTS public.commerce_discount_redemptions;
DROP SEQUENCE IF EXISTS public.commerce_customer_addresses_id_seq;
DROP TABLE IF EXISTS public.commerce_customer_addresses;
DROP SEQUENCE IF EXISTS public.commerce_customer_address_books_id_seq;
DROP TABLE IF EXISTS public.commerce_customer_address_books;
DROP SEQUENCE IF EXISTS public.commerce_commission_policy_events_id_seq;
DROP TABLE IF EXISTS public.commerce_commission_policy_events;
DROP SEQUENCE IF EXISTS public.commerce_chargebacks_id_seq;
DROP TABLE IF EXISTS public.commerce_chargebacks;
DROP SEQUENCE IF EXISTS public.commerce_chargeback_lines_id_seq;
DROP TABLE IF EXISTS public.commerce_chargeback_lines;
DROP SEQUENCE IF EXISTS public.commerce_categories_id_seq;
DROP TABLE IF EXISTS public.commerce_categories;
DROP SEQUENCE IF EXISTS public.commerce_carts_id_seq;
DROP TABLE IF EXISTS public.commerce_carts;
DROP SEQUENCE IF EXISTS public.commerce_cart_lines_id_seq;
DROP TABLE IF EXISTS public.commerce_cart_lines;
DROP SEQUENCE IF EXISTS public.commerce_attributes_id_seq;
DROP TABLE IF EXISTS public.commerce_attributes;
DROP SEQUENCE IF EXISTS public.commerce_attribute_values_id_seq;
DROP TABLE IF EXISTS public.commerce_attribute_values;
...
CREATE TABLE public.billing_plans (
    ...
    gateway_product_id character varying(100),
    gateway_price_id character varying(100),
    metadata jsonb,
    status character varying(20) DEFAULT 'active'::character varying,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
--
-- Name: commerce_attribute_values; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_attribute_values (
    id bigint NOT NULL,
    uuid character varying(12),
    attribute_uuid character varying(12),
...
--
-- Name: commerce_attribute_values_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_attribute_values_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_attribute_values_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_attribute_values_id_seq OWNED BY public.commerce_attribute_values.id;


--
-- Name: commerce_attributes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_attributes (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    slug character varying(191),
...
--
-- Name: commerce_attributes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_attributes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_attributes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_attributes_id_seq OWNED BY public.commerce_attributes.id;


--
-- Name: commerce_cart_lines; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_cart_lines (
    id bigint NOT NULL,
    uuid character varying(12),
    cart_uuid character varying(12),
    variant_uuid character varying(12),
    quantity integer,
    addons jsonb,
    addons_hash character varying(64) DEFAULT ''::character varying,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone
);
...
--
-- Name: commerce_cart_lines_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_cart_lines_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_cart_lines_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_cart_lines_id_seq OWNED BY public.commerce_cart_lines.id;
...
--
-- Name: commerce_carts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_carts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_carts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_carts_id_seq OWNED BY public.commerce_carts.id;


--
-- Name: commerce_categories; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: commerce_categories_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_categories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_categories_id_seq OWNED BY public.commerce_categories.id;


--
-- Name: commerce_chargeback_lines; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_chargeback_lines (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    chargeback_uuid character varying(12),
    order_line_uuid character varying(12),
    seller_uuid character varying(12),
    amount bigint,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone
);
...
--
-- Name: commerce_chargeback_lines_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_chargeback_lines_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_chargeback_lines_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_chargeback_lines_id_seq OWNED BY public.commerce_chargeback_lines.id;


--
-- Name: commerce_chargebacks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_chargebacks (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    ...
    occurred_at timestamp without time zone,
    kind character varying(16) DEFAULT 'chargeback'::character varying,
    related_chargeback_uuid character varying(12),
    status character varying(24) DEFAULT 'received'::character varying,
...
--
-- Name: commerce_chargebacks_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_chargebacks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_chargebacks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_chargebacks_id_seq OWNED BY public.commerce_chargebacks.id;


--
-- Name: commerce_commission_policy_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_commission_policy_events (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
...
--
-- Name: commerce_commission_policy_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_commission_policy_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_commission_policy_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_commission_policy_events_id_seq OWNED BY public.commerce_commission_policy_events.id;


--
-- Name: commerce_customer_address_books; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_customer_address_books (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    user_uuid character varying(12),
...
--
-- Name: commerce_customer_address_books_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_customer_address_books_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_customer_address_books_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_customer_address_books_id_seq OWNED BY public.commerce_customer_address_books.id;


--
-- Name: commerce_customer_addresses; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_customer_addresses (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    user_uuid character varying(12),
...
--
-- Name: commerce_customer_addresses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_customer_addresses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_customer_addresses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_customer_addresses_id_seq OWNED BY public.commerce_customer_addresses.id;
...
CREATE TABLE public.commerce_discount_redemptions (
    ...
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    discount_uuid character varying(12),
    order_uuid character varying(12),
    buyer_identity character varying(255),
    buyer_key character varying(255),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


--
-- Name: commerce_discount_redemptions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_discount_redemptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_discount_redemptions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_discount_redemptions_id_seq OWNED BY public.commerce_discount_redemptions.id;
...
CREATE TABLE public.commerce_discounts (
    ...
    usage_limit bigint,
    once_per_buyer boolean DEFAULT false,
...
--
-- Name: commerce_download_grants; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.commerce_download_grants (
    ...
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    order_uuid character varying(12),
    download_uuid character varying(12),
    blob_uuid character varying(12),
    name character varying(255),
    token_hash character varying(64),
    remaining bigint,
    ...
    last_minted_at timestamp without time zone,
    revoked_at timestamp without time zone,
    refund_access_override_at timestamp without time zone,
    refund_access_override_by character varying(12),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


--
-- Name: commerce_download_grants_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_download_grants_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_download_grants_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_download_grants_id_seq OWNED BY public.commerce_download_grants.id;


--
-- Name: commerce_downloads; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_downloads (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    variant_uuid character varying(12),
...
--
-- Name: commerce_downloads_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_downloads_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_downloads_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_downloads_id_seq OWNED BY public.commerce_downloads.id;


--
-- Name: commerce_ledger_account_locks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_ledger_account_locks (
    id bigint NOT NULL,
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    account_key character varying(32),
    currency character varying(3),
...
--
-- Name: commerce_ledger_account_locks_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_ledger_account_locks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_ledger_account_locks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_ledger_account_locks_id_seq OWNED BY public.commerce_ledger_account_locks.id;


--
-- Name: commerce_marketplace_ledger; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_marketplace_ledger (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    account_key character varying(32),
    account_kind character varying(12),
    seller_uuid character varying(12),
    currency character varying(3),
    entry_type character varying(24),
    amount bigint,
    order_uuid character varying(12),
    seller_order_uuid character varying(12),
    refund_uuid character varying(12),
    payout_uuid character varying(12),
    reserve_uuid character varying(12),
    chargeback_uuid character varying(12),
    idempotency_key character varying(191),
    reason character varying(255),
    created_by character varying(12),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT commerce_marketplace_ledger_check CHECK (((((account_kind)::text = 'seller'::text) AND (seller_uuid IS NOT NULL) AND ((account_key)::text = ('seller:'::text || (seller_uuid)::text))) OR (((account_kind)::text = 'marketplace'::text) AND (seller_uuid IS NULL) AND ((account_key)::text = 'marketplace'::text))))
);


--
-- Name: commerce_marketplace_ledger_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_marketplace_ledger_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_marketplace_ledger_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_marketplace_ledger_id_seq OWNED BY public.commerce_marketplace_ledger.id;


--
-- Name: commerce_marketplace_settings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_marketplace_settings (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    status character varying(16),
    default_seller_uuid character varying(12),
    commission_kind character varying(16),
    commission_bps integer,
    commission_fixed bigint,
    activated_by character varying(12),
    activated_at timestamp without time zone,
    reserve_bps integer DEFAULT 0,
...
--
-- Name: commerce_marketplace_settings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_marketplace_settings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_marketplace_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_marketplace_settings_id_seq OWNED BY public.commerce_marketplace_settings.id;


--
-- Name: commerce_order_draft_attempts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_order_draft_attempts (
    id bigint NOT NULL,
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    idempotency_key character varying(191),
...
--
-- Name: commerce_order_draft_attempts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_order_draft_attempts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_order_draft_attempts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_order_draft_attempts_id_seq OWNED BY public.commerce_order_draft_attempts.id;
...
CREATE TABLE public.commerce_order_events (
    ...
    payload jsonb,
    actor_uuid character varying(12),
    visibility character varying(16) DEFAULT 'internal'::character varying,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


--
-- Name: commerce_order_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_order_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_order_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_order_events_id_seq OWNED BY public.commerce_order_events.id;


--
-- Name: commerce_order_lines; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.commerce_order_lines (
    ...
    commission_source character varying(16),
    commission_kind character varying(16),
    commission_bps integer,
    commission_fixed bigint,
    commission_basis bigint DEFAULT 0,
...
--
-- Name: commerce_order_lines_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_order_lines_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_order_lines_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_order_lines_id_seq OWNED BY public.commerce_order_lines.id;
...
CREATE TABLE public.commerce_orders (
    ...
    status character varying(24) DEFAULT 'pending_payment'::character varying,
    fulfillment_status character varying(16) DEFAULT 'unfulfilled'::character varying,
    marketplace_partitioned boolean DEFAULT false,
    fulfillment_revision bigint DEFAULT 0,
    tracking_ref character varying(191),
    ...
    shipping_total bigint DEFAULT 0,
    tax_total bigint DEFAULT 0,
    grand_total bigint,
    refunded_total bigint DEFAULT 0,
    refund_revision bigint DEFAULT 0,
    discount_code character varying(64),
    shipping_method character varying(64),
    addresses jsonb,
    metadata jsonb,
    ...
    phone_display character varying(32),
    customer_name character varying(255),
    origin character varying(16) DEFAULT 'storefront'::character varying NOT NULL,
    fulfillment_mode character varying(16) DEFAULT 'delivery'::character varying NOT NULL,
    draft_revision integer DEFAULT 0 NOT NULL
);


--
-- Name: commerce_orders_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_orders_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_orders_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: commerce_payment_links; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.commerce_payment_links (
    ...
    consumed_at timestamp without time zone,
    revoked_at timestamp without time zone,
    initiation_window_started_at timestamp without time zone,
    initiation_count integer DEFAULT 0 NOT NULL,
    provider_session_issued_at timestamp without time zone,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone
);
...
--
-- Name: commerce_payment_links_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_payment_links_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_payment_links_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_payment_links_id_seq OWNED BY public.commerce_payment_links.id;


--
-- Name: commerce_payouts; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.commerce_payouts (
    ...
    currency character varying(3),
    amount bigint,
    external_ref character varying(191),
    note character varying(255),
    created_by character varying(12),
    idempotency_key character varying(191),
    status character varying(16) DEFAULT 'paid'::character varying,
    method character varying(16) DEFAULT 'manual'::character varying,
    provider character varying(32),
    provider_ref character varying(191),
    destination_ref character varying(191),
    ...
    reversed_total bigint DEFAULT 0,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone,
    completed_at timestamp without time zone,
    CONSTRAINT commerce_payouts_amount_check CHECK ((amount > 0))
);


--
-- Name: commerce_payouts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_payouts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_payouts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_payouts_id_seq OWNED BY public.commerce_payouts.id;


--
-- Name: commerce_product_addons; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_product_addons (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    product_uuid character varying(12),
    name character varying(255),
    field_type character varying(16),
...
--
-- Name: commerce_product_addons_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_product_addons_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_product_addons_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_product_addons_id_seq OWNED BY public.commerce_product_addons.id;


--
-- Name: commerce_product_attributes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_product_attributes (
    id bigint NOT NULL,
    uuid character varying(12),
    product_uuid character varying(12),
    attribute_uuid character varying(12),
    name character varying(255),
    "values" jsonb,
    used_for_variants boolean DEFAULT false,
...
--
-- Name: commerce_product_attributes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_product_attributes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_product_attributes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_product_attributes_id_seq OWNED BY public.commerce_product_attributes.id;
...
CREATE TABLE public.commerce_product_categories (
    id bigint NOT NULL,
    product_uuid character varying(12),
    category_uuid character varying(12)
);


--
-- Name: commerce_product_categories_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_product_categories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_product_categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_product_categories_id_seq OWNED BY public.commerce_product_categories.id;


--
-- Name: commerce_product_children; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_product_children (
    id bigint NOT NULL,
    product_uuid character varying(12),
    child_uuid character varying(12),
    "position" integer DEFAULT 0
);


--
-- Name: commerce_product_children_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_product_children_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_product_children_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_product_children_id_seq OWNED BY public.commerce_product_children.id;
...
CREATE TABLE public.commerce_product_media (
    ...
    variant_uuid character varying(12),
    blob_uuid character varying(12),
    role character varying(16) DEFAULT 'gallery'::character varying,
    "position" integer DEFAULT 0,
...
--
-- Name: commerce_product_media_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_product_media_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_product_media_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_product_media_id_seq OWNED BY public.commerce_product_media.id;


--
-- Name: commerce_product_tags; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_product_tags (
    id bigint NOT NULL,
    product_uuid character varying(12),
    tag_uuid character varying(12)
);


--
-- Name: commerce_product_tags_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_product_tags_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_product_tags_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_product_tags_id_seq OWNED BY public.commerce_product_tags.id;
...
CREATE TABLE public.commerce_products (
    ...
    name character varying(255),
    description text,
    type character varying(16) DEFAULT 'physical'::character varying,
    ...
    tax_class character varying(16),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone,
    deleted_at timestamp without time zone
);
...
--
-- Name: commerce_products_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_products_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_products_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_products_id_seq OWNED BY public.commerce_products.id;


--
-- Name: commerce_refund_lines; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: commerce_refund_lines_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_refund_lines_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_refund_lines_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_refund_lines_id_seq OWNED BY public.commerce_refund_lines.id;
...
CREATE TABLE public.commerce_refunds (
    ...
    provider_ref character varying(191),
    failure_reason text,
    initiated_by character varying(12),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone,
    completed_at timestamp without time zone
);
...
--
-- Name: commerce_refunds_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_refunds_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_refunds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_refunds_id_seq OWNED BY public.commerce_refunds.id;


--
-- Name: commerce_reserve_policy_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_reserve_policy_events (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    subject_kind character varying(16),
...
--
-- Name: commerce_reserve_policy_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_reserve_policy_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_reserve_policy_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_reserve_policy_events_id_seq OWNED BY public.commerce_reserve_policy_events.id;


--
-- Name: commerce_reviews; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: commerce_reviews_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_reviews_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_reviews_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_reviews_id_seq OWNED BY public.commerce_reviews.id;


--
-- Name: commerce_seller_api_key_credentials; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_api_key_credentials (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    lineage_uuid character varying(12),
    framework_key_uuid character varying(12),
    generation integer,
    relationship character varying(16),
...
--
-- Name: commerce_seller_api_key_credentials_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_api_key_credentials_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_api_key_credentials_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_api_key_credentials_id_seq OWNED BY public.commerce_seller_api_key_credentials.id;


--
-- Name: commerce_seller_api_key_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_api_key_events (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    lineage_uuid character varying(12),
    seller_uuid character varying(12),
    subject_user_uuid character varying(12),
    action character varying(16),
    actor_uuid character varying(12),
    reason_code character varying(48),
    bucket_start timestamp without time zone,
    predecessor_key_uuid character varying(12),
    successor_key_uuid character varying(12),
    grace_expires_at timestamp without time zone,
    detail text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Name: commerce_seller_api_key_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_api_key_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_api_key_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_api_key_events_id_seq OWNED BY public.commerce_seller_api_key_events.id;


--
-- Name: commerce_seller_api_keys; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_api_keys (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    seller_uuid character varying(12),
    ...
    status character varying(16) DEFAULT 'active'::character varying,
    current_credential_uuid character varying(12),
    expires_at timestamp without time zone,
    revision integer DEFAULT 0,
    created_by character varying(12),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
...
--
-- Name: commerce_seller_api_keys_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_api_keys_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_api_keys_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_api_keys_id_seq OWNED BY public.commerce_seller_api_keys.id;


--
-- Name: commerce_seller_lifecycle_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_lifecycle_events (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    seller_uuid character varying(12),
    ...
    actor_uuid character varying(12) NOT NULL,
    reason character varying(255),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Name: commerce_seller_lifecycle_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_lifecycle_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_lifecycle_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_lifecycle_events_id_seq OWNED BY public.commerce_seller_lifecycle_events.id;


--
-- Name: commerce_seller_memberships; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_memberships (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    seller_uuid character varying(12),
...
--
-- Name: commerce_seller_memberships_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_memberships_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_memberships_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_memberships_id_seq OWNED BY public.commerce_seller_memberships.id;


--
-- Name: commerce_seller_orders; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_orders (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12),
    order_uuid character varying(12),
    seller_uuid character varying(12),
    seller_name_snapshot character varying(160),
    partition_number integer,
    seller_reference character varying(96),
    currency character varying(3),
    subtotal bigint,
    allocated_discount bigint DEFAULT 0,
    allocated_shipping_discount bigint DEFAULT 0,
    allocated_shipping bigint DEFAULT 0,
    allocated_tax bigint DEFAULT 0,
    attributed_total bigint,
    commission_amount bigint DEFAULT 0,
    tax_attribution_method character varying(20),
    confirmed_at timestamp without time zone,
    fulfillment_status character varying(16) DEFAULT 'unfulfilled'::character varying,
    fulfilled_at timestamp without time zone,
    carrier character varying(96),
...
--
-- Name: commerce_seller_orders_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_orders_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_orders_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_orders_id_seq OWNED BY public.commerce_seller_orders.id;


--
-- Name: commerce_seller_payout_accounts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_payout_accounts (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    seller_uuid character varying(12),
    provider character varying(32),
    account_ref character varying(191),
    readiness_state character varying(16) DEFAULT 'pending'::character varying,
...
--
-- Name: commerce_seller_payout_accounts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_payout_accounts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_payout_accounts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_payout_accounts_id_seq OWNED BY public.commerce_seller_payout_accounts.id;


--
-- Name: commerce_seller_reserves; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_reserves (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    seller_uuid character varying(12),
    ...
    idempotency_key character varying(128),
    amount bigint,
    reserve_bps_snapshot integer,
    reserve_days_snapshot integer,
    status character varying(16) DEFAULT 'held'::character varying,
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone,
    CONSTRAINT commerce_seller_reserves_amount_check CHECK ((amount > 0))
);


--
-- Name: commerce_seller_reserves_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_reserves_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_reserves_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_reserves_id_seq OWNED BY public.commerce_seller_reserves.id;


--
-- Name: commerce_seller_webhook_deliveries; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_webhook_deliveries (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    endpoint_uuid character varying(12),
    webhook_event_uuid character varying(12),
    seller_uuid character varying(12),
    status character varying(16) DEFAULT 'pending'::character varying,
...
--
-- Name: commerce_seller_webhook_deliveries_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_webhook_deliveries_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_webhook_deliveries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_webhook_deliveries_id_seq OWNED BY public.commerce_seller_webhook_deliveries.id;


--
-- Name: commerce_seller_webhook_endpoint_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_webhook_endpoint_events (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    endpoint_uuid character varying(12),
...
--
-- Name: commerce_seller_webhook_endpoint_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_webhook_endpoint_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_webhook_endpoint_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_webhook_endpoint_events_id_seq OWNED BY public.commerce_seller_webhook_endpoint_events.id;


--
-- Name: commerce_seller_webhook_endpoints; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_webhook_endpoints (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    seller_uuid character varying(12),
...
--
-- Name: commerce_seller_webhook_endpoints_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_webhook_endpoints_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_webhook_endpoints_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_webhook_endpoints_id_seq OWNED BY public.commerce_seller_webhook_endpoints.id;


--
-- Name: commerce_seller_webhook_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_webhook_events (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    seller_uuid character varying(12),
    ...
    payload text,
    occurred_at timestamp without time zone,
    source_ref character varying(191),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


--
-- Name: commerce_seller_webhook_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_webhook_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_webhook_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_webhook_events_id_seq OWNED BY public.commerce_seller_webhook_events.id;


--
-- Name: commerce_seller_webhook_secrets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_seller_webhook_secrets (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    endpoint_uuid character varying(12),
    secret_ciphertext text,
    secret_fingerprint character varying(64),
    relationship character varying(16),
    overlap_expires_at timestamp without time zone,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    revoked_at timestamp without time zone
);
...
--
-- Name: commerce_seller_webhook_secrets_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_seller_webhook_secrets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_seller_webhook_secrets_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_seller_webhook_secrets_id_seq OWNED BY public.commerce_seller_webhook_secrets.id;


--
-- Name: commerce_sellers; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_sellers (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    slug character varying(64),
...
--
-- Name: commerce_sellers_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_sellers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_sellers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_sellers_id_seq OWNED BY public.commerce_sellers.id;


--
-- Name: commerce_sequences; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_sequences (
    id bigint NOT NULL,
    tenant_uuid character varying(12) DEFAULT ''::character varying,
...
--
-- Name: commerce_sequences_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_sequences_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_sequences_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_sequences_id_seq OWNED BY public.commerce_sequences.id;


--
-- Name: commerce_shipping_classes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_shipping_classes (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    slug character varying(64),
...
--
-- Name: commerce_shipping_classes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_shipping_classes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_shipping_classes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_shipping_classes_id_seq OWNED BY public.commerce_shipping_classes.id;


--
-- Name: commerce_shipping_methods; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_shipping_methods (
    id bigint NOT NULL,
    uuid character varying(12),
    zone_uuid character varying(12),
...
--
-- Name: commerce_shipping_methods_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_shipping_methods_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_shipping_methods_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_shipping_methods_id_seq OWNED BY public.commerce_shipping_methods.id;


--
-- Name: commerce_shipping_zone_locations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_shipping_zone_locations (
    id bigint NOT NULL,
    zone_uuid character varying(12),
...
--
-- Name: commerce_shipping_zone_locations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_shipping_zone_locations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_shipping_zone_locations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_shipping_zone_locations_id_seq OWNED BY public.commerce_shipping_zone_locations.id;


--
-- Name: commerce_shipping_zones; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: commerce_shipping_zones_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_shipping_zones_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_shipping_zones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_shipping_zones_id_seq OWNED BY public.commerce_shipping_zones.id;


--
-- Name: commerce_stock; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_stock (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    variant_uuid character varying(12),
...
--
-- Name: commerce_stock_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_stock_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_stock_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_stock_id_seq OWNED BY public.commerce_stock.id;


--
-- Name: commerce_stock_movements; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.commerce_stock_movements (
    ...
    reference_uuid character varying(12),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


--
-- Name: commerce_stock_movements_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_stock_movements_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_stock_movements_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_stock_movements_id_seq OWNED BY public.commerce_stock_movements.id;


--
-- Name: commerce_tags; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_tags (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    slug character varying(191),
...
--
-- Name: commerce_tags_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_tags_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_tags_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_tags_id_seq OWNED BY public.commerce_tags.id;


--
-- Name: commerce_tax_rates; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.commerce_tax_rates (
    ...
    postcode_pattern character varying(32),
    rate_bps integer,
    label character varying(255),
    priority integer DEFAULT 0,
    shipping_taxable boolean DEFAULT false,
    class character varying(16) DEFAULT 'standard'::character varying,
    revision integer DEFAULT 0,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone
);
...
--
-- Name: commerce_tax_rates_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_tax_rates_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_tax_rates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_tax_rates_id_seq OWNED BY public.commerce_tax_rates.id;
...
CREATE TABLE public.commerce_variants (
    ...
    "position" integer DEFAULT 0,
    status character varying(16) DEFAULT 'active'::character varying,
    shipping_class_uuid character varying(12),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone
);
...
--
-- Name: commerce_variants_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_variants_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_variants_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_variants_id_seq OWNED BY public.commerce_variants.id;


--
-- Name: commerce_wishlist_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_wishlist_items (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    user_uuid character varying(12),
...
--
-- Name: commerce_wishlist_items_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_wishlist_items_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_wishlist_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_wishlist_items_id_seq OWNED BY public.commerce_wishlist_items.id;


--
-- Name: commerce_wishlists; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.commerce_wishlists (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    user_uuid character varying(12),
...
--
-- Name: commerce_wishlists_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.commerce_wishlists_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commerce_wishlists_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.commerce_wishlists_id_seq OWNED BY public.commerce_wishlists.id;
...
CREATE TABLE public.content_types (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone,
    CONSTRAINT content_types_status_check CHECK (((status)::text = ANY (ARRAY[('active'::character varying)::text, ('archived'::character varying)::text, ('deleted'::character varying)::text])))
);
...
CREATE TABLE public.entries (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone,
    CONSTRAINT entries_status_check CHECK (((status)::text = ANY (ARRAY[('active'::character varying)::text, ('archived'::character varying)::text, ('deleted'::character varying)::text])))
);
...
CREATE TABLE public.entry_redirects (
    ...
    CONSTRAINT chk_entry_redirect_origin CHECK (((origin)::text = ANY (ARRAY[('auto'::character varying)::text, ('manual'::character varying)::text]))),
...
CREATE TABLE public.entry_schedules (
    ...
    CONSTRAINT chk_schedule_action CHECK (((action)::text = ANY (ARRAY[('publish'::character varying)::text, ('unpublish'::character varying)::text]))),
    CONSTRAINT chk_schedule_status CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('processing'::character varying)::text, ('done'::character varying)::text, ('failed'::character varying)::text, ('canceled'::character varying)::text])))
);
...
CREATE TABLE public.entry_schema_migrations (
    ...
    started_at timestamp without time zone,
    completed_at timestamp without time zone,
    CONSTRAINT chk_entry_schema_migration_status CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('running'::character varying)::text, ('completed'::character varying)::text, ('failed'::character varying)::text])))
);
...
--
-- Name: gateway_subscriptions; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.gateway_subscriptions (
    ...
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    gateway character varying(50),
    gateway_subscription_id character varying(191),
    gateway_customer_id character varying(191),
    gateway_price_id character varying(191),
    billing_plan_uuid character varying(12),
...
--
-- Name: gateway_subscriptions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: gateway_subscriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.invoices (
    ...
    user_uuid character varying(12),
    billing_plan_uuid character varying(12),
    payable_type character varying(100),
...
CREATE TABLE public.job_executions (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT job_executions_status_check CHECK (((status)::text = ANY (ARRAY[('success'::character varying)::text, ('failure'::character varying)::text, ('running'::character varying)::text])))
);
...
--
-- Name: payvia_transfers; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.payvia_transfers (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    gateway character varying(50),
    idempotency_key character varying(191),
    provider_reference character varying(191),
    provider_ref character varying(191),
    destination_ref character varying(191),
    amount bigint,
    currency character varying(3),
...
--
-- Name: payvia_transfers_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.payvia_transfers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: payvia_transfers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.payvia_transfers_id_seq OWNED BY public.payvia_transfers.id;
...
CREATE TABLE public.permission_audit (
    ...
    user_agent text,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT permission_audit_action_check CHECK (((action)::text = ANY (ARRAY[('GRANTED'::character varying)::text, ('REVOKED'::character varying)::text, ('MODIFIED'::character varying)::text, ('EXPIRED'::character varying)::text]))),
    CONSTRAINT permission_audit_subject_type_check CHECK (((subject_type)::text = ANY (ARRAY[('user'::character varying)::text, ('role'::character varying)::text])))
);
...
CREATE TABLE public.provider_events (
    ...
    provider_event_id character varying(191),
    delivery_key character varying(191),
    logical_event_key character varying(191),
    type character varying(100),
    status character varying(20) DEFAULT 'received'::character varying,
    dispatch_status character varying(20) DEFAULT 'pending'::character varying,
    ...
    dispatch_claim_token character varying(64)
);
...
--
-- Name: subscription_checkout_originations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.subscription_checkout_originations (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    subject_key character varying(191),
    gateway character varying(50),
    provider_plan_identifier character varying(191),
    idempotency_key character varying(191),
    request_fingerprint character varying(64),
    initialization_claim_token character varying(12),
    initialization_claimed_at timestamp without time zone,
    customer_email character varying(254),
    return_url character varying(2048),
    cancel_url character varying(2048),
    checkout_reference character varying(191),
    checkout_url character varying(2048),
    provider_subscription_id character varying(191),
    provider_customer_code character varying(191),
    provider_plan_code character varying(191),
    status character varying(24),
    live boolean DEFAULT true,
    required_projection_consumer character varying(50),
    projection_event_key character varying(191),
    projection_outcome character varying(24),
    projection_reason character varying(255),
    consumer_metadata jsonb,
    provider_expires_at timestamp without time zone,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone,
    reconciliation_resolution character varying(40),
    reconciliation_note character varying(255),
    reconciled_at timestamp without time zone
);


--
-- Name: subscription_checkout_originations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.subscription_checkout_originations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: subscription_checkout_originations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.subscription_checkout_originations_id_seq OWNED BY public.subscription_checkout_originations.id;


--
-- Name: subscription_checkout_subject_guards; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.subscription_checkout_subject_guards (
    id bigint NOT NULL,
    uuid character varying(12),
    tenant_uuid character varying(12) DEFAULT ''::character varying,
    subject_key character varying(191),
    state character varying(16) DEFAULT 'open'::character varying,
    origination_uuid character varying(12),
...
--
-- Name: subscription_checkout_subject_guards_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.subscription_checkout_subject_guards_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: subscription_checkout_subject_guards_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.subscription_checkout_subject_guards_id_seq OWNED BY public.subscription_checkout_subject_guards.id;
...
--
-- Name: commerce_attribute_values id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_attribute_values ALTER COLUMN id SET DEFAULT nextval('public.commerce_attribute_values_id_seq'::regclass);


--
-- Name: commerce_attributes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_attributes ALTER COLUMN id SET DEFAULT nextval('public.commerce_attributes_id_seq'::regclass);


--
-- Name: commerce_cart_lines id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_cart_lines ALTER COLUMN id SET DEFAULT nextval('public.commerce_cart_lines_id_seq'::regclass);


--
-- Name: commerce_carts id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_carts ALTER COLUMN id SET DEFAULT nextval('public.commerce_carts_id_seq'::regclass);


--
-- Name: commerce_categories id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_categories ALTER COLUMN id SET DEFAULT nextval('public.commerce_categories_id_seq'::regclass);


--
-- Name: commerce_chargeback_lines id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_chargeback_lines ALTER COLUMN id SET DEFAULT nextval('public.commerce_chargeback_lines_id_seq'::regclass);


--
-- Name: commerce_chargebacks id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_chargebacks ALTER COLUMN id SET DEFAULT nextval('public.commerce_chargebacks_id_seq'::regclass);


--
-- Name: commerce_commission_policy_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_commission_policy_events ALTER COLUMN id SET DEFAULT nextval('public.commerce_commission_policy_events_id_seq'::regclass);


--
-- Name: commerce_customer_address_books id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_customer_address_books ALTER COLUMN id SET DEFAULT nextval('public.commerce_customer_address_books_id_seq'::regclass);


--
-- Name: commerce_customer_addresses id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_customer_addresses ALTER COLUMN id SET DEFAULT nextval('public.commerce_customer_addresses_id_seq'::regclass);


--
-- Name: commerce_discount_redemptions id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_discount_redemptions ALTER COLUMN id SET DEFAULT nextval('public.commerce_discount_redemptions_id_seq'::regclass);
...
--
-- Name: commerce_download_grants id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_download_grants ALTER COLUMN id SET DEFAULT nextval('public.commerce_download_grants_id_seq'::regclass);


--
-- Name: commerce_downloads id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_downloads ALTER COLUMN id SET DEFAULT nextval('public.commerce_downloads_id_seq'::regclass);


--
-- Name: commerce_ledger_account_locks id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_ledger_account_locks ALTER COLUMN id SET DEFAULT nextval('public.commerce_ledger_account_locks_id_seq'::regclass);


--
-- Name: commerce_marketplace_ledger id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_marketplace_ledger ALTER COLUMN id SET DEFAULT nextval('public.commerce_marketplace_ledger_id_seq'::regclass);


--
-- Name: commerce_marketplace_settings id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_marketplace_settings ALTER COLUMN id SET DEFAULT nextval('public.commerce_marketplace_settings_id_seq'::regclass);


--
-- Name: commerce_order_draft_attempts id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_order_draft_attempts ALTER COLUMN id SET DEFAULT nextval('public.commerce_order_draft_attempts_id_seq'::regclass);


--
-- Name: commerce_order_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_order_events ALTER COLUMN id SET DEFAULT nextval('public.commerce_order_events_id_seq'::regclass);


--
-- Name: commerce_order_lines id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_order_lines ALTER COLUMN id SET DEFAULT nextval('public.commerce_order_lines_id_seq'::regclass);


--
-- Name: commerce_orders id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: commerce_payment_links id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_payment_links ALTER COLUMN id SET DEFAULT nextval('public.commerce_payment_links_id_seq'::regclass);


--
-- Name: commerce_payouts id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_payouts ALTER COLUMN id SET DEFAULT nextval('public.commerce_payouts_id_seq'::regclass);


--
-- Name: commerce_product_addons id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_addons ALTER COLUMN id SET DEFAULT nextval('public.commerce_product_addons_id_seq'::regclass);


--
-- Name: commerce_product_attributes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_attributes ALTER COLUMN id SET DEFAULT nextval('public.commerce_product_attributes_id_seq'::regclass);


--
-- Name: commerce_product_categories id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_categories ALTER COLUMN id SET DEFAULT nextval('public.commerce_product_categories_id_seq'::regclass);


--
-- Name: commerce_product_children id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_children ALTER COLUMN id SET DEFAULT nextval('public.commerce_product_children_id_seq'::regclass);


--
-- Name: commerce_product_media id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_media ALTER COLUMN id SET DEFAULT nextval('public.commerce_product_media_id_seq'::regclass);


--
-- Name: commerce_product_tags id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_tags ALTER COLUMN id SET DEFAULT nextval('public.commerce_product_tags_id_seq'::regclass);


--
-- Name: commerce_products id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_products ALTER COLUMN id SET DEFAULT nextval('public.commerce_products_id_seq'::regclass);


--
-- Name: commerce_refund_lines id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_refund_lines ALTER COLUMN id SET DEFAULT nextval('public.commerce_refund_lines_id_seq'::regclass);


--
-- Name: commerce_refunds id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_refunds ALTER COLUMN id SET DEFAULT nextval('public.commerce_refunds_id_seq'::regclass);


--
-- Name: commerce_reserve_policy_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_reserve_policy_events ALTER COLUMN id SET DEFAULT nextval('public.commerce_reserve_policy_events_id_seq'::regclass);


--
-- Name: commerce_reviews id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_reviews ALTER COLUMN id SET DEFAULT nextval('public.commerce_reviews_id_seq'::regclass);


--
-- Name: commerce_seller_api_key_credentials id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_key_credentials ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_api_key_credentials_id_seq'::regclass);


--
-- Name: commerce_seller_api_key_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_key_events ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_api_key_events_id_seq'::regclass);


--
-- Name: commerce_seller_api_keys id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_keys ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_api_keys_id_seq'::regclass);


--
-- Name: commerce_seller_lifecycle_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_lifecycle_events ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_lifecycle_events_id_seq'::regclass);


--
-- Name: commerce_seller_memberships id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_memberships ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_memberships_id_seq'::regclass);


--
-- Name: commerce_seller_orders id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_orders ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_orders_id_seq'::regclass);


--
-- Name: commerce_seller_payout_accounts id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_payout_accounts ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_payout_accounts_id_seq'::regclass);


--
-- Name: commerce_seller_reserves id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_reserves ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_reserves_id_seq'::regclass);


--
-- Name: commerce_seller_webhook_deliveries id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_deliveries ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_webhook_deliveries_id_seq'::regclass);


--
-- Name: commerce_seller_webhook_endpoint_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_endpoint_events ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_webhook_endpoint_events_id_seq'::regclass);


--
-- Name: commerce_seller_webhook_endpoints id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_endpoints ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_webhook_endpoints_id_seq'::regclass);


--
-- Name: commerce_seller_webhook_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_events ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_webhook_events_id_seq'::regclass);


--
-- Name: commerce_seller_webhook_secrets id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_secrets ALTER COLUMN id SET DEFAULT nextval('public.commerce_seller_webhook_secrets_id_seq'::regclass);


--
-- Name: commerce_sellers id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_sellers ALTER COLUMN id SET DEFAULT nextval('public.commerce_sellers_id_seq'::regclass);


--
-- Name: commerce_sequences id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_sequences ALTER COLUMN id SET DEFAULT nextval('public.commerce_sequences_id_seq'::regclass);


--
-- Name: commerce_shipping_classes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_classes ALTER COLUMN id SET DEFAULT nextval('public.commerce_shipping_classes_id_seq'::regclass);


--
-- Name: commerce_shipping_methods id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_methods ALTER COLUMN id SET DEFAULT nextval('public.commerce_shipping_methods_id_seq'::regclass);


--
-- Name: commerce_shipping_zone_locations id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_zone_locations ALTER COLUMN id SET DEFAULT nextval('public.commerce_shipping_zone_locations_id_seq'::regclass);


--
-- Name: commerce_shipping_zones id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_zones ALTER COLUMN id SET DEFAULT nextval('public.commerce_shipping_zones_id_seq'::regclass);


--
-- Name: commerce_stock id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_stock ALTER COLUMN id SET DEFAULT nextval('public.commerce_stock_id_seq'::regclass);


--
-- Name: commerce_stock_movements id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_stock_movements ALTER COLUMN id SET DEFAULT nextval('public.commerce_stock_movements_id_seq'::regclass);


--
-- Name: commerce_tags id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_tags ALTER COLUMN id SET DEFAULT nextval('public.commerce_tags_id_seq'::regclass);


--
-- Name: commerce_tax_rates id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_tax_rates ALTER COLUMN id SET DEFAULT nextval('public.commerce_tax_rates_id_seq'::regclass);


--
-- Name: commerce_variants id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_variants ALTER COLUMN id SET DEFAULT nextval('public.commerce_variants_id_seq'::regclass);


--
-- Name: commerce_wishlist_items id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_wishlist_items ALTER COLUMN id SET DEFAULT nextval('public.commerce_wishlist_items_id_seq'::regclass);


--
-- Name: commerce_wishlists id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_wishlists ALTER COLUMN id SET DEFAULT nextval('public.commerce_wishlists_id_seq'::regclass);
...
--
-- Name: gateway_subscriptions id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: payvia_transfers id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payvia_transfers ALTER COLUMN id SET DEFAULT nextval('public.payvia_transfers_id_seq'::regclass);
...
--
-- Name: subscription_checkout_originations id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_originations ALTER COLUMN id SET DEFAULT nextval('public.subscription_checkout_originations_id_seq'::regclass);


--
-- Name: subscription_checkout_subject_guards id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_subject_guards ALTER COLUMN id SET DEFAULT nextval('public.subscription_checkout_subject_guards_id_seq'::regclass);
...
COPY public.billing_plans (id, uuid, tenant_uuid, name, description, amount, currency, "interval", trial_days, gateway, gateway_product_id, gateway_price_id, metadata, status, created_at, updated_at) FROM stdin;
\.
...
COPY public.block_types (id, uuid, slug, label, icon, category, description, schema, active, created_at, updated_at, style_capabilities, style_targets, flags, starter_content) FROM stdin;
...
4	dOdH9fXSwwLg	grid	Grid	i-lucide-layout-grid	Layout	A responsive wrapping grid (or masonry flow) of blocks.	[{"enum": ["1", "2", "3", "4"], "name": "columns", "type": "enum"}, {"enum": ["grid", "masonry"], "name": "flow", "type": "enum"}, {"enum": ["small", "medium", "large"], "name": "gap", "type": "enum"}, {"name": "items", "type": "blocks"}]	t	2026-09-14 07:35:10	2026-09-14 07:35:10	\N	\N	\N	\N
...
8	oBkZBfyjwTmW	accordion	Accordion	i-lucide-list-collapse	Content	A stack of expandable question/answer items.	[{"name": "title", "type": "string"}, {"name": "multiple", "type": "boolean"}, {"name": "items", "type": "blocks", "block_types": ["accordion_item"]}]	t	2026-09-14 07:35:10	2026-09-14 07:35:10	\N	\N	\N	\N
9	8ECSUEf4C6yn	collapsible	Collapsible	i-lucide-chevrons-up-down	Content	A single show/hide disclosure wrapping nested blocks.	[{"name": "label", "type": "string"}, {"name": "open", "type": "boolean"}, {"name": "content", "type": "blocks"}]	t	2026-09-14 07:35:10	2026-09-14 07:35:10	\N	\N	\N	\N
10	cB8Uo7Z2zdMq	links	Links	i-lucide-list	Content	A vertical list of navigation links with an optional title.	[{"name": "title", "type": "string"}, {"name": "items", "type": "json"}]	t	2026-09-14 07:35:10	2026-09-14 07:35:10	\N	\N	\N	\N
...
13	nwMCoIiw1Krn	color_mode	Color mode	i-lucide-sun-moon	Content	A light / system / dark color-mode switch for visitors.	[]	t	2026-09-14 07:35:10	2026-09-14 07:35:10	\N	\N	\N	\N
14	9DbE17P6hwgm	logos	Logos	i-lucide-building-2	Media	A “trusted by” strip of brand logos.	[{"name": "title", "type": "string"}, {"name": "images", "type": "asset", "multiple": true}, {"name": "grayscale", "type": "boolean"}, {"name": "scroll", "type": "boolean"}]	t	2026-09-14 07:35:10	2026-09-14 07:35:10	\N	\N	\N	\N
15	vxtN1yK5Lq7y	accordion_item	Accordion item	i-lucide-chevron-down	Items	One question with a rich-text answer.	[{"name": "question", "type": "string", "required": true}, {"name": "answer", "type": "text", "format": "rich"}]	t	2026-09-14 07:35:10	2026-09-14 07:35:10	\N	\N	\N	\N
16	CtDSbJoqhUW3	stepper_item	Stepper item	i-lucide-circle-dot	Items	One numbered step: title and description.	[{"name": "title", "type": "string", "required": true}, {"name": "description", "type": "text"}]	t	2026-09-14 07:35:10	2026-09-14 07:35:10	\N	\N	\N	\N
...
19	W9UWdd0xU8qo	spacer	Spacer	i-lucide-move-vertical	Layout	Vertical breathing room.	[{"enum": ["small", "medium", "large"], "name": "size", "type": "enum"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
...
21	8xXTrQFyRSan	rich_text	Rich text	i-lucide-text	Content	Free-form formatted text.	[{"name": "body", "type": "text", "format": "rich"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
...
25	PjavxKn1e5El	tabs	Tabs	i-lucide-panels-top-left	Content	Tabbed panels of blocks.	[{"name": "items", "type": "blocks", "block_types": ["tab"]}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
...
30	aqQtZ3IFDNKD	logo	Logo	i-lucide-badge-check	Media	The site logo (Settings → General); falls back to the site name.	[{"enum": ["small", "medium", "large"], "name": "size", "type": "enum"}, {"name": "link_home", "type": "boolean"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
...
32	i0P5JVm4dwch	social_links	Social links	i-lucide-share-2	Content	A row of brand icons linking to social profiles.	[{"name": "items", "type": "blocks", "block_types": ["social_link"]}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
...
34	9dcm9rz78D74	audio	Audio	i-lucide-audio-lines	Media	An uploaded audio file with native controls.	[{"name": "audio", "type": "asset", "required": true}, {"name": "title", "type": "string"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
35	Homzct2WJ9Bh	file	File	i-lucide-file	Media	A download link to an uploaded file.	[{"name": "file", "type": "asset", "required": true}, {"name": "label", "type": "string"}, {"name": "new_tab", "type": "boolean"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
...
37	kuCJQNsglJ6v	html	HTML	i-lucide-code	Advanced	Raw HTML, rendered verbatim. Trusted editors only — activate to opt in.	[{"name": "code", "type": "text"}]	f	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
38	vGF2gEu2IoVd	shortcode	Shortcode	i-lucide-braces	Advanced	Renders shortcodes/{name}.twig from the theme (or a DB template).	[{"name": "name", "type": "string", "pattern": "[a-z][a-z0-9_-]*", "required": true}, {"name": "params", "type": "json"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
39	HtocIaPuv8jV	feature	Feature	i-lucide-check	Items	One feature: icon, title, description, link.	[{"name": "icon", "type": "string", "format": "icon", "pattern": "[a-z0-9]+(-[a-z0-9]+)*"}, {"name": "title", "type": "string", "required": true}, {"name": "description", "type": "text"}, {"name": "url", "type": "string"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
40	1lqkQmP5zWcl	tab	Tab	i-lucide-panel-top	Items	One tab: label and panel blocks.	[{"name": "label", "type": "string", "required": true}, {"name": "content", "type": "blocks"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
41	BSDgTh1XCFdy	social_link	Social link	i-lucide-link	Items	One social profile: brand icon + URL.	[{"name": "icon", "type": "string", "format": "brand-icon", "pattern": "brand:[a-z0-9]+(-[a-z0-9]+)*", "required": true}, {"name": "url", "type": "string", "required": true}, {"name": "label", "type": "string"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
28	tcIAcQ70xDtq	image	Image	i-lucide-image	Media	A single image with caption.	[{"name": "image", "type": "asset", "required": true}, {"name": "alt", "type": "string"}, {"name": "caption", "type": "string"}]	t	2026-09-14 07:35:13	2026-09-14 11:25:03	\N	\N	\N	\N
...
44	QS3hGM3tYtVB	pricing_table	Pricing table	i-lucide-table	Content	A feature-comparison table across pricing tiers.	[{"name": "tiers", "type": "blocks", "block_types": ["pricing_tier"]}, {"name": "features", "type": "blocks", "block_types": ["pricing_feature"]}, {"name": "highlight", "type": "boolean"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
...
49	zi1oIhaiD4mP	login-form	Sign-in form	i-lucide-log-in	Account	The sign-in form, embeddable on any page. A failed attempt returns to this page with an inline error.	[{"name": "heading", "type": "string"}, {"name": "next", "type": "string"}, {"name": "show_links", "type": "boolean"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
50	NfcxzCsFs9O6	register-form	Registration form	i-lucide-user-plus	Account	The create-account form, embeddable on any page. Continues into the email-verification flow.	[{"name": "heading", "type": "string"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
51	5rg33pxdbO1k	forgot-password-form	Password reset request	i-lucide-key-round	Account	The request-a-reset-code form, embeddable on any page. Continues into the reset flow.	[{"name": "heading", "type": "string"}]	t	2026-09-14 07:35:13	2026-09-14 07:35:13	\N	\N	\N	\N
22	GZlOUnGRAdeI	heading	Heading	i-lucide-heading	Content	A single heading or label line.	[{"name": "text", "type": "string", "required": true}, {"enum": ["h1", "h2", "h3", "h4", "h5", "h6"], "name": "level", "type": "enum"}]	t	2026-09-14 07:35:13	2026-09-14 11:25:03	\N	\N	\N	\N
12	LxWZL6PE4Q5Y	button	Button	i-lucide-mouse-pointer-click	Content	A standalone action button.	[{"name": "label", "type": "string", "required": true}, {"name": "url", "type": "string", "required": true}, {"enum": ["solid", "outline", "soft", "subtle", "ghost", "link"], "name": "variant", "type": "enum"}, {"enum": ["primary", "neutral"], "name": "color", "type": "enum"}, {"enum": ["xs", "sm", "md", "lg", "xl"], "name": "size", "type": "enum"}, {"name": "leading_icon", "type": "string", "format": "icon", "pattern": "[a-z0-9]+(-[a-z0-9]+)*"}, {"name": "trailing_icon", "type": "string", "format": "icon", "pattern": "[a-z0-9]+(-[a-z0-9]+)*"}, {"name": "block", "type": "boolean"}]	t	2026-09-14 07:35:10	2026-09-14 11:25:03	\N	\N	\N	\N
26	B9ZoVqRQfSxs	carousel	Carousel	i-lucide-gallery-horizontal	Content	A swipeable slider — each child block is a slide.	[{"name": "slides", "type": "blocks"}, {"enum": ["1", "2", "3"], "name": "slides_per_view", "type": "enum"}, {"name": "arrows", "type": "boolean"}, {"name": "dots", "type": "boolean"}, {"name": "autoplay", "type": "boolean"}, {"enum": ["default", "hero"], "name": "style", "type": "enum"}, {"enum": ["slide", "fade", "zoom"], "name": "transition", "type": "enum", "enum_labels": {"fade": "Fade", "zoom": "Zoom (Ken Burns)", "slide": "Slide"}}, {"enum": ["compact", "standard", "tall", "full"], "name": "height", "type": "enum"}]	t	2026-09-14 07:35:13	2026-09-14 11:25:03	\N	\N	\N	\N
\.
...
--
-- Data for Name: commerce_attribute_values; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_attribute_values (id, uuid, attribute_uuid, slug, value, "position") FROM stdin;
\.


--
-- Data for Name: commerce_attributes; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_attributes (id, uuid, tenant_uuid, slug, name, "position", revision) FROM stdin;
\.


--
-- Data for Name: commerce_cart_lines; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_cart_lines (id, uuid, cart_uuid, variant_uuid, quantity, addons, addons_hash, created_at, updated_at) FROM stdin;
\.
...
COPY public.commerce_carts (id, uuid, tenant_uuid, token_hash, user_uuid, discount_code, status, expires_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_categories; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_categories (id, uuid, tenant_uuid, parent_uuid, slug, name, description, "position", revision, blob_uuid) FROM stdin;
\.


--
-- Data for Name: commerce_chargeback_lines; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_chargeback_lines (id, uuid, tenant_uuid, chargeback_uuid, order_line_uuid, seller_uuid, amount, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_chargebacks; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_chargebacks (id, uuid, tenant_uuid, provider, provider_event_id, payment_reference, order_uuid, amount, currency, reason_code, occurred_at, kind, related_chargeback_uuid, status, posted_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_commission_policy_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_commission_policy_events (id, uuid, tenant_uuid, subject_kind, subject_uuid, actor_uuid, before_policy, after_policy, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_customer_address_books; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_customer_address_books (id, uuid, tenant_uuid, user_uuid, revision, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_customer_addresses; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_customer_addresses (id, uuid, tenant_uuid, user_uuid, label, address, is_default_shipping, is_default_billing, created_at, updated_at) FROM stdin;
\.
...
COPY public.commerce_discount_redemptions (id, uuid, tenant_uuid, discount_uuid, order_uuid, buyer_identity, buyer_key, created_at) FROM stdin;
\.
...
COPY public.commerce_discounts (id, uuid, tenant_uuid, code, type, value, min_subtotal, starts_at, ends_at, usage_limit, once_per_buyer, usage_count, product_scope, status, revision, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_download_grants; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_download_grants (id, uuid, tenant_uuid, order_uuid, download_uuid, blob_uuid, name, token_hash, remaining, expires_at, mint_count, last_minted_at, revoked_at, refund_access_override_at, refund_access_override_by, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_downloads; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_downloads (id, uuid, tenant_uuid, variant_uuid, blob_uuid, name, download_limit, expiry_days, "position", status, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_ledger_account_locks; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_ledger_account_locks (id, tenant_uuid, account_key, currency, revision, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_marketplace_ledger; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_marketplace_ledger (id, uuid, tenant_uuid, account_key, account_kind, seller_uuid, currency, entry_type, amount, order_uuid, seller_order_uuid, refund_uuid, payout_uuid, reserve_uuid, chargeback_uuid, idempotency_key, reason, created_by, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_marketplace_settings; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_marketplace_settings (id, uuid, tenant_uuid, status, default_seller_uuid, commission_kind, commission_bps, commission_fixed, activated_by, activated_at, reserve_bps, reserve_days, revision, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_order_draft_attempts; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_order_draft_attempts (id, tenant_uuid, idempotency_key, request_fingerprint, order_uuid, status, completed_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.commerce_order_events (id, uuid, order_uuid, type, payload, actor_uuid, visibility, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_order_lines; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_order_lines (id, uuid, order_uuid, variant_uuid, product_name, sku, option_values, unit_price, quantity, line_total, seller_uuid, discount_amount, tax_amount, commission_source, commission_kind, commission_bps, commission_fixed, commission_basis, commission_amount, addons, downloads) FROM stdin;
\.
...
COPY public.commerce_orders (id, uuid, tenant_uuid, order_number, status, fulfillment_status, marketplace_partitioned, fulfillment_revision, tracking_ref, email, user_uuid, guest_token_hash, currency, subtotal, discount_total, shipping_total, tax_total, grand_total, refunded_total, refund_revision, discount_code, shipping_method, addresses, metadata, placed_at, created_at, updated_at, phone_normalized, phone_display, customer_name, origin, fulfillment_mode, draft_revision) FROM stdin;
\.


--
-- Data for Name: commerce_payment_links; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_payment_links (id, uuid, tenant_uuid, order_uuid, token_hash, status, expires_at, created_by, consumed_at, revoked_at, initiation_window_started_at, initiation_count, provider_session_issued_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_payouts; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_payouts (id, uuid, tenant_uuid, seller_uuid, currency, amount, external_ref, note, created_by, idempotency_key, status, method, provider, provider_ref, destination_ref, failure_code, failure_reason, retryable, attempt_count, last_attempt_at, next_attempt_at, next_reconcile_at, reversed_total, created_at, updated_at, completed_at) FROM stdin;
\.


--
-- Data for Name: commerce_product_addons; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_product_addons (id, uuid, tenant_uuid, product_uuid, name, field_type, required, choices, price_delta, "position", status) FROM stdin;
\.


--
-- Data for Name: commerce_product_attributes; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_product_attributes (id, uuid, product_uuid, attribute_uuid, name, "values", used_for_variants, visible, "position") FROM stdin;
\.
...
COPY public.commerce_product_categories (id, product_uuid, category_uuid) FROM stdin;
\.


--
-- Data for Name: commerce_product_children; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_product_children (id, product_uuid, child_uuid, "position") FROM stdin;
\.
...
COPY public.commerce_product_media (id, uuid, tenant_uuid, product_uuid, variant_uuid, blob_uuid, role, "position", alt) FROM stdin;
\.


--
-- Data for Name: commerce_product_tags; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_product_tags (id, product_uuid, tag_uuid) FROM stdin;
\.
...
COPY public.commerce_products (id, uuid, tenant_uuid, seller_uuid, commission_kind, commission_bps, commission_fixed, slug, name, description, type, status, options, metadata, rating_sum, rating_count, catalog_revision, tax_class, created_at, updated_at, deleted_at) FROM stdin;
\.


--
-- Data for Name: commerce_refund_lines; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_refund_lines (id, refund_uuid, order_line_uuid, quantity, amount) FROM stdin;
\.


--
-- Data for Name: commerce_refunds; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_refunds (id, uuid, tenant_uuid, order_uuid, idempotency_key, request_fingerprint, amount, currency, method, status, reason, restocked, provider_ref, failure_reason, initiated_by, created_at, updated_at, completed_at) FROM stdin;
\.


--
-- Data for Name: commerce_reserve_policy_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_reserve_policy_events (id, uuid, tenant_uuid, subject_kind, subject_uuid, actor_uuid, before_policy, after_policy, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_reviews; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_reviews (id, uuid, tenant_uuid, product_uuid, user_uuid, author_name, author_email, rating, body, status, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_api_key_credentials; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_api_key_credentials (id, uuid, tenant_uuid, lineage_uuid, framework_key_uuid, generation, relationship, grace_expires_at, created_at, revoked_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_api_key_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_api_key_events (id, uuid, tenant_uuid, lineage_uuid, seller_uuid, subject_user_uuid, action, actor_uuid, reason_code, bucket_start, predecessor_key_uuid, successor_key_uuid, grace_expires_at, detail, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_api_keys; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_api_keys (id, uuid, tenant_uuid, seller_uuid, subject_user_uuid, declared_scopes, name, status, current_credential_uuid, expires_at, revision, created_by, created_at, updated_at, last_rotated_at, revoked_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_lifecycle_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_lifecycle_events (id, uuid, tenant_uuid, seller_uuid, from_status, to_status, actor_uuid, reason, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_memberships; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_memberships (id, uuid, tenant_uuid, seller_uuid, user_uuid, role, status, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_orders; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_orders (id, uuid, tenant_uuid, order_uuid, seller_uuid, seller_name_snapshot, partition_number, seller_reference, currency, subtotal, allocated_discount, allocated_shipping_discount, allocated_shipping, allocated_tax, attributed_total, commission_amount, tax_attribution_method, confirmed_at, fulfillment_status, fulfilled_at, carrier, tracking_number, tracking_url, status, revision, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_payout_accounts; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_payout_accounts (id, uuid, tenant_uuid, seller_uuid, provider, account_ref, readiness_state, last_synced_at, failure_code, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_reserves; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_reserves (id, uuid, tenant_uuid, seller_uuid, currency, source_kind, seller_order_uuid, idempotency_key, amount, reserve_bps_snapshot, reserve_days_snapshot, status, held_at, release_at, closed_at, created_by, reason, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_webhook_deliveries; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_webhook_deliveries (id, uuid, tenant_uuid, endpoint_uuid, webhook_event_uuid, seller_uuid, status, attempts, next_attempt_at, paused_at, paused_remaining_seconds, pause_reason, claim_token, claim_expires_at, last_attempt_at, last_status_code, last_error, replay_of_uuid, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_webhook_endpoint_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_webhook_endpoint_events (id, uuid, tenant_uuid, endpoint_uuid, seller_uuid, action, actor_uuid, reason, detail, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_webhook_endpoints; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_webhook_endpoints (id, uuid, tenant_uuid, seller_uuid, url, subscribed_events, status, revision, consecutive_failures, created_by, disabled_at, disabled_reason, deleted_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_webhook_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_webhook_events (id, uuid, tenant_uuid, seller_uuid, event_type, payload, occurred_at, source_ref, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_seller_webhook_secrets; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_seller_webhook_secrets (id, uuid, tenant_uuid, endpoint_uuid, secret_ciphertext, secret_fingerprint, relationship, overlap_expires_at, created_at, revoked_at) FROM stdin;
\.


--
-- Data for Name: commerce_sellers; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_sellers (id, uuid, tenant_uuid, slug, name, metadata, commission_kind, commission_bps, commission_fixed, reserve_bps, reserve_days, status, revision, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_sequences; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_sequences (id, tenant_uuid, name, value) FROM stdin;
\.


--
-- Data for Name: commerce_shipping_classes; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_shipping_classes (id, uuid, tenant_uuid, slug, name, revision, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_shipping_methods; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_shipping_methods (id, uuid, zone_uuid, kind, label, config, "position", enabled, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_shipping_zone_locations; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_shipping_zone_locations (id, zone_uuid, kind, value) FROM stdin;
\.


--
-- Data for Name: commerce_shipping_zones; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_shipping_zones (id, uuid, tenant_uuid, name, "position", revision, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_stock; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_stock (id, uuid, tenant_uuid, variant_uuid, quantity, tracked, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_stock_movements; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_stock_movements (id, uuid, tenant_uuid, variant_uuid, delta, reason, reference_uuid, created_at) FROM stdin;
\.


--
-- Data for Name: commerce_tags; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_tags (id, uuid, tenant_uuid, slug, name, revision) FROM stdin;
\.


--
-- Data for Name: commerce_tax_rates; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_tax_rates (id, uuid, tenant_uuid, country, state, postcode_pattern, rate_bps, label, priority, shipping_taxable, class, revision, created_at, updated_at) FROM stdin;
\.
...
COPY public.commerce_variants (id, uuid, tenant_uuid, product_uuid, sku, option_values, price, compare_at_price, currency, "position", status, shipping_class_uuid, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_wishlist_items; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_wishlist_items (id, uuid, tenant_uuid, user_uuid, product_uuid, "position", created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: commerce_wishlists; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.commerce_wishlists (id, uuid, tenant_uuid, user_uuid, revision, created_at, updated_at) FROM stdin;
\.
...
1	FblJoFGImtwf	en	{"body": [{"id": "SioLHcLsdEDY", "data": {"text": "Heading alpha v2", "level": "h2"}, "type": "heading", "settings": {"style": {"colors": {"text": {"type": "token", "value": "color.accent"}}, "alignment": {"text": {"base": {"type": "choice", "value": "start"}}}}}}, {"id": "aiguJWhEurXd", "data": {"url": "/go", "size": "lg", "label": "Go", "variant": "solid"}, "type": "button", "settings": {"style": {"radius": {"type": "token", "value": "radius.none"}, "alignment": {"content": {"base": {"type": "choice", "value": "center"}}}}}}, {"id": "EnE84CSl1Bxd", "data": {"prefix": "Build", "suffix": "sites", "prefix_color": {"type": "token", "value": "color.accent"}, "rotate_color": {"type": "token", "value": "color.accent"}, "rotate_words": "fast\\nwell", "suffix_color": {"type": "token", "value": "color.accent"}}, "type": "animated_text"}, {"id": "P24zjqFmOTnz", "data": {"alt": "pixel", "image": "COUOJiK8gwgW"}, "type": "image", "settings": {"style": {"width": {"base": {"type": "token", "value": "width.container"}}}}}, {"id": "fbqxcdeF5acx", "data": {"speed": "normal", "slides": [{"id": "PxYbKmBmQa8U", "data": {"content": "<p>slide</p>"}, "type": "rich_text"}]}, "type": "carousel"}, {"id": "YMMsTdoiLzQM", "data": {"gap": 12, "margin": {"top": 8, "bottom": 8}, "radius": {"top": 12, "left": 12, "right": 12, "bottom": 12}, "shadow": "md", "content": [{"id": "NzCRNjGNesiM", "data": {"margin": "small", "shadow": "lg", "content": [{"id": "ZvAinlxJ4BCm", "data": {"text": "Nested", "level": "h3"}, "type": "heading", "settings": {"style": {"alignment": {"text": {"base": {"type": "choice", "value": "center"}}}}}}], "padding": "medium", "class_hook": "promo", "shadow_color": "#123456", "shadow_opacity": 40}, "type": "style"}], "padding": {"top": 17, "left": 17, "right": 17, "bottom": 17}, "max_width": 900, "min_height": "half", "border_color": "#123456", "border_style": "solid", "border_width": 2, "min_height_px": 420, "overlay_color": "#000000", "padding_preset": "large", "overlay_opacity": 40, "background_color": "#f0f0f0"}, "type": "container"}], "title": "Published alpha again", "_schema": {"settings": 1, "conversions": ["presentation-group-1"]}}	1	3	user00000001	2026-09-14 11:25:03
2	37k4MCyYH9Qp	en	{"body": [{"id": "kjxPPMwnvWoH", "data": {"text": "Heading beta v2", "level": "h2"}, "type": "heading", "settings": {"style": {"colors": {"text": {"type": "token", "value": "color.accent"}}, "alignment": {"text": {"base": {"type": "choice", "value": "start"}}}}}}, {"id": "tujzFKwkVfE1", "data": {"url": "/go", "size": "lg", "label": "Go", "variant": "solid"}, "type": "button", "settings": {"style": {"radius": {"type": "token", "value": "radius.none"}, "alignment": {"content": {"base": {"type": "choice", "value": "center"}}}}}}, {"id": "jifSCu6OI72s", "data": {"prefix": "Build", "suffix": "sites", "prefix_color": {"type": "token", "value": "color.accent"}, "rotate_color": {"type": "token", "value": "color.accent"}, "rotate_words": "fast\\nwell", "suffix_color": {"type": "token", "value": "color.accent"}}, "type": "animated_text"}, {"id": "eQhQrmDcfN0D", "data": {"alt": "pixel", "image": "COUOJiK8gwgW"}, "type": "image", "settings": {"style": {"width": {"base": {"type": "token", "value": "width.container"}}}}}, {"id": "LWK8V4QpiRSR", "data": {"speed": "normal", "slides": [{"id": "bW1wk9e6IlBO", "data": {"content": "<p>slide</p>"}, "type": "rich_text"}]}, "type": "carousel"}, {"id": "3f0oMrrGiJ3U", "data": {"gap": 12, "margin": {"top": 8, "bottom": 8}, "radius": {"top": 12, "left": 12, "right": 12, "bottom": 12}, "shadow": "md", "content": [{"id": "uJnpKxx1m7oT", "data": {"margin": "small", "shadow": "lg", "content": [{"id": "evEAq8xX7U8j", "data": {"text": "Nested", "level": "h3"}, "type": "heading", "settings": {"style": {"alignment": {"text": {"base": {"type": "choice", "value": "center"}}}}}}], "padding": "medium", "class_hook": "promo", "shadow_color": "#123456", "shadow_opacity": 40}, "type": "style"}], "padding": {"top": 17, "left": 17, "right": 17, "bottom": 17}, "max_width": 900, "min_height": "half", "border_color": "#123456", "border_style": "solid", "border_width": 2, "min_height_px": 420, "overlay_color": "#000000", "padding_preset": "large", "overlay_opacity": 40, "background_color": "#f0f0f0"}, "type": "container"}], "title": "Published beta again", "_schema": {"settings": 1, "conversions": ["presentation-group-1"]}}	1	3	user00000001	2026-09-14 11:25:03
3	Rw4X0rkKfMi2	en	{"body": [{"id": "5itGbbE7tluf", "data": {"text": "Heading gamma", "level": "h2"}, "type": "heading", "settings": {"style": {"colors": {"text": {"type": "token", "value": "color.accent"}}, "alignment": {"text": {"base": {"type": "choice", "value": "start"}}}}}}, {"id": "ZkaXPrpvpuU0", "data": {"url": "/go", "size": "lg", "label": "Go", "variant": "solid"}, "type": "button", "settings": {"style": {"radius": {"type": "token", "value": "radius.none"}, "alignment": {"content": {"base": {"type": "choice", "value": "center"}}}}}}, {"id": "JEqNOLBNx5jG", "data": {"prefix": "Build", "suffix": "sites", "prefix_color": {"type": "token", "value": "color.accent"}, "rotate_color": {"type": "token", "value": "color.accent"}, "rotate_words": "fast\\nwell", "suffix_color": {"type": "token", "value": "color.accent"}}, "type": "animated_text"}, {"id": "JHGB2zxXuBqS", "data": {"alt": "pixel", "image": "COUOJiK8gwgW"}, "type": "image", "settings": {"style": {"width": {"base": {"type": "token", "value": "width.container"}}}}}, {"id": "EBHXYzruGdYX", "data": {"speed": "normal", "slides": [{"id": "bLdQ6DqKTOna", "data": {"content": "<p>slide</p>"}, "type": "rich_text"}]}, "type": "carousel"}, {"id": "Ek84mYukeeqQ", "data": {"gap": 12, "margin": {"top": 8, "bottom": 8}, "radius": {"top": 12, "left": 12, "right": 12, "bottom": 12}, "shadow": "md", "content": [{"id": "Au0Ie3SzMFfa", "data": {"margin": "small", "shadow": "lg", "content": [{"id": "Wp6EoN3TPG7M", "data": {"text": "Nested", "level": "h3"}, "type": "heading", "settings": {"style": {"alignment": {"text": {"base": {"type": "choice", "value": "center"}}}}}}], "padding": "medium", "class_hook": "promo", "shadow_color": "#123456", "shadow_opacity": 40}, "type": "style"}], "padding": {"top": 17, "left": 17, "right": 17, "bottom": 17}, "max_width": 900, "min_height": "half", "border_color": "#123456", "border_style": "solid", "border_width": 2, "min_height_px": 420, "overlay_color": "#000000", "padding_preset": "large", "overlay_opacity": 40, "background_color": "#f0f0f0"}, "type": "container"}], "title": "Draft gamma", "_schema": {"settings": 1, "conversions": ["presentation-group-1"]}}	1	2	user00000001	2026-09-14 11:25:03
4	I1hUrUPOH3Aw	en	{"body": [{"id": "n0CpRLorpAW4", "data": {"text": "Heading delta", "level": "h2"}, "type": "heading", "settings": {"style": {"colors": {"text": {"type": "token", "value": "color.accent"}}, "alignment": {"text": {"base": {"type": "choice", "value": "start"}}}}}}, {"id": "LcBgta3fLpCW", "data": {"url": "/go", "size": "lg", "label": "Go", "variant": "solid"}, "type": "button", "settings": {"style": {"radius": {"type": "token", "value": "radius.none"}, "alignment": {"content": {"base": {"type": "choice", "value": "center"}}}}}}, {"id": "pcT8Bcqx05nD", "data": {"prefix": "Build", "suffix": "sites", "prefix_color": {"type": "token", "value": "color.accent"}, "rotate_color": {"type": "token", "value": "color.accent"}, "rotate_words": "fast\\nwell", "suffix_color": {"type": "token", "value": "color.accent"}}, "type": "animated_text"}, {"id": "pwL6e0446bV8", "data": {"alt": "pixel", "image": "COUOJiK8gwgW"}, "type": "image", "settings": {"style": {"width": {"base": {"type": "token", "value": "width.container"}}}}}, {"id": "7KH3UxFxku2L", "data": {"speed": "normal", "slides": [{"id": "H5zKKzOqYJDe", "data": {"content": "<p>slide</p>"}, "type": "rich_text"}]}, "type": "carousel"}, {"id": "zZxB54Tpnk1H", "data": {"gap": 12, "margin": {"top": 8, "bottom": 8}, "radius": {"top": 12, "left": 12, "right": 12, "bottom": 12}, "shadow": "md", "content": [{"id": "5hVL83cx8kQb", "data": {"margin": "small", "shadow": "lg", "content": [{"id": "TSLYN3ZDfVGY", "data": {"text": "Nested", "level": "h3"}, "type": "heading", "settings": {"style": {"alignment": {"text": {"base": {"type": "choice", "value": "center"}}}}}}], "padding": "medium", "class_hook": "promo", "shadow_color": "#123456", "shadow_opacity": 40}, "type": "style"}], "padding": {"top": 17, "left": 17, "right": 17, "bottom": 17}, "max_width": 900, "min_height": "half", "border_color": "#123456", "border_style": "solid", "border_width": 2, "min_height_px": 420, "overlay_color": "#000000", "padding_preset": "large", "overlay_opacity": 40, "background_color": "#f0f0f0"}, "type": "container"}], "title": "Draft delta", "_schema": {"settings": 1, "conversions": ["presentation-group-1"]}}	1	2	user00000001	2026-09-14 11:25:03
\.
...
1	ejkQN8l5X8FZ	FblJoFGImtwf	en	1	{"body": [{"id": "FTeQDnVttL4i", "data": {"text": "Heading alpha v1", "level": "h2"}, "type": "heading", "settings": {"style": {"colors": {"text": {"type": "token", "value": "color.accent"}}, "alignment": {"text": {"base": {"type": "choice", "value": "start"}}}}}}, {"id": "F2CL0eUPomPN", "data": {"url": "/go", "size": "lg", "label": "Go", "variant": "solid"}, "type": "button", "settings": {"style": {"radius": {"type": "token", "value": "radius.none"}, "alignment": {"content": {"base": {"type": "choice", "value": "center"}}}}}}, {"id": "yk94C2WFBKfy", "data": {"prefix": "Build", "suffix": "sites", "prefix_color": {"type": "token", "value": "color.accent"}, "rotate_color": {"type": "token", "value": "color.accent"}, "rotate_words": "fast\\nwell", "suffix_color": {"type": "token", "value": "color.accent"}}, "type": "animated_text"}, {"id": "enxVMeXmSOfj", "data": {"alt": "pixel", "image": "COUOJiK8gwgW"}, "type": "image", "settings": {"style": {"width": {"base": {"type": "token", "value": "width.container"}}}}}, {"id": "JwYiMu6Onnfm", "data": {"speed": "normal", "slides": [{"id": "fDCTqUP6LYRI", "data": [], "type": "rich_text"}]}, "type": "carousel"}, {"id": "cwfW7fEqK5Gg", "data": {"gap": 12, "margin": {"top": 8, "bottom": 8}, "radius": {"top": 12, "left": 12, "right": 12, "bottom": 12}, "shadow": "md", "content": [{"id": "VOFFQQT0Vl7C", "data": {"margin": "small", "shadow": "lg", "content": [{"id": "DFQh57ii3guY", "data": {"text": "Nested", "level": "h3"}, "type": "heading", "settings": {"style": {"alignment": {"text": {"base": {"type": "choice", "value": "center"}}}}}}], "padding": "medium", "class_hook": "promo", "shadow_color": "#123456", "shadow_opacity": 40}, "type": "style"}], "padding": {"top": 17, "left": 17, "right": 17, "bottom": 17}, "max_width": 900, "min_height": "half", "border_color": "#123456", "border_style": "solid", "border_width": 2, "min_height_px": 420, "overlay_color": "#000000", "padding_preset": "large", "overlay_opacity": 40, "background_color": "#f0f0f0"}, "type": "container"}], "title": "Published alpha", "_schema": {"settings": 1, "conversions": ["presentation-group-1"]}}	1	user00000001	2026-09-14 07:35:13.590092
2	mjw39sg4I1HG	FblJoFGImtwf	en	2	{"body": [{"id": "SioLHcLsdEDY", "data": {"text": "Heading alpha v2", "level": "h2"}, "type": "heading", "settings": {"style": {"colors": {"text": {"type": "token", "value": "color.accent"}}, "alignment": {"text": {"base": {"type": "choice", "value": "start"}}}}}}, {"id": "aiguJWhEurXd", "data": {"url": "/go", "size": "lg", "label": "Go", "variant": "solid"}, "type": "button", "settings": {"style": {"radius": {"type": "token", "value": "radius.none"}, "alignment": {"content": {"base": {"type": "choice", "value": "center"}}}}}}, {"id": "EnE84CSl1Bxd", "data": {"prefix": "Build", "suffix": "sites", "prefix_color": {"type": "token", "value": "color.accent"}, "rotate_color": {"type": "token", "value": "color.accent"}, "rotate_words": "fast\\nwell", "suffix_color": {"type": "token", "value": "color.accent"}}, "type": "animated_text"}, {"id": "P24zjqFmOTnz", "data": {"alt": "pixel", "image": "COUOJiK8gwgW"}, "type": "image", "settings": {"style": {"width": {"base": {"type": "token", "value": "width.container"}}}}}, {"id": "fbqxcdeF5acx", "data": {"speed": "normal", "slides": [{"id": "PxYbKmBmQa8U", "data": [], "type": "rich_text"}]}, "type": "carousel"}, {"id": "YMMsTdoiLzQM", "data": {"gap": 12, "margin": {"top": 8, "bottom": 8}, "radius": {"top": 12, "left": 12, "right": 12, "bottom": 12}, "shadow": "md", "content": [{"id": "NzCRNjGNesiM", "data": {"margin": "small", "shadow": "lg", "content": [{"id": "ZvAinlxJ4BCm", "data": {"text": "Nested", "level": "h3"}, "type": "heading", "settings": {"style": {"alignment": {"text": {"base": {"type": "choice", "value": "center"}}}}}}], "padding": "medium", "class_hook": "promo", "shadow_color": "#123456", "shadow_opacity": 40}, "type": "style"}], "padding": {"top": 17, "left": 17, "right": 17, "bottom": 17}, "max_width": 900, "min_height": "half", "border_color": "#123456", "border_style": "solid", "border_width": 2, "min_height_px": 420, "overlay_color": "#000000", "padding_preset": "large", "overlay_opacity": 40, "background_color": "#f0f0f0"}, "type": "container"}], "title": "Published alpha again", "_schema": {"settings": 1, "conversions": ["presentation-group-1"]}}	1	user00000001	2026-09-14 07:35:13.595368
3	2L3oVZ9HcvVc	37k4MCyYH9Qp	en	1	{"body": [{"id": "jj5fufUkCDTJ", "data": {"text": "Heading beta v1", "level": "h2"}, "type": "heading", "settings": {"style": {"colors": {"text": {"type": "token", "value": "color.accent"}}, "alignment": {"text": {"base": {"type": "choice", "value": "start"}}}}}}, {"id": "UMqyb5xDfInm", "data": {"url": "/go", "size": "lg", "label": "Go", "variant": "solid"}, "type": "button", "settings": {"style": {"radius": {"type": "token", "value": "radius.none"}, "alignment": {"content": {"base": {"type": "choice", "value": "center"}}}}}}, {"id": "61G5Y0F42A30", "data": {"prefix": "Build", "suffix": "sites", "prefix_color": {"type": "token", "value": "color.accent"}, "rotate_color": {"type": "token", "value": "color.accent"}, "rotate_words": "fast\\nwell", "suffix_color": {"type": "token", "value": "color.accent"}}, "type": "animated_text"}, {"id": "YrfrZURM9zme", "data": {"alt": "pixel", "image": "COUOJiK8gwgW"}, "type": "image", "settings": {"style": {"width": {"base": {"type": "token", "value": "width.container"}}}}}, {"id": "TsMl9oMspDsz", "data": {"speed": "normal", "slides": [{"id": "h7p2y1VqL1wg", "data": [], "type": "rich_text"}]}, "type": "carousel"}, {"id": "rQU71yGJAOUv", "data": {"gap": 12, "margin": {"top": 8, "bottom": 8}, "radius": {"top": 12, "left": 12, "right": 12, "bottom": 12}, "shadow": "md", "content": [{"id": "2sVPntbOWs8q", "data": {"margin": "small", "shadow": "lg", "content": [{"id": "BvyqM2QQRHKy", "data": {"text": "Nested", "level": "h3"}, "type": "heading", "settings": {"style": {"alignment": {"text": {"base": {"type": "choice", "value": "center"}}}}}}], "padding": "medium", "class_hook": "promo", "shadow_color": "#123456", "shadow_opacity": 40}, "type": "style"}], "padding": {"top": 17, "left": 17, "right": 17, "bottom": 17}, "max_width": 900, "min_height": "half", "border_color": "#123456", "border_style": "solid", "border_width": 2, "min_height_px": 420, "overlay_color": "#000000", "padding_preset": "large", "overlay_opacity": 40, "background_color": "#f0f0f0"}, "type": "container"}], "title": "Published beta", "_schema": {"settings": 1, "conversions": ["presentation-group-1"]}}	1	user00000001	2026-09-14 07:35:13.599446
4	bOIe9tX7LTQB	37k4MCyYH9Qp	en	2	{"body": [{"id": "kjxPPMwnvWoH", "data": {"text": "Heading beta v2", "level": "h2"}, "type": "heading", "settings": {"style": {"colors": {"text": {"type": "token", "value": "color.accent"}}, "alignment": {"text": {"base": {"type": "choice", "value": "start"}}}}}}, {"id": "tujzFKwkVfE1", "data": {"url": "/go", "size": "lg", "label": "Go", "variant": "solid"}, "type": "button", "settings": {"style": {"radius": {"type": "token", "value": "radius.none"}, "alignment": {"content": {"base": {"type": "choice", "value": "center"}}}}}}, {"id": "jifSCu6OI72s", "data": {"prefix": "Build", "suffix": "sites", "prefix_color": {"type": "token", "value": "color.accent"}, "rotate_color": {"type": "token", "value": "color.accent"}, "rotate_words": "fast\\nwell", "suffix_color": {"type": "token", "value": "color.accent"}}, "type": "animated_text"}, {"id": "eQhQrmDcfN0D", "data": {"alt": "pixel", "image": "COUOJiK8gwgW"}, "type": "image", "settings": {"style": {"width": {"base": {"type": "token", "value": "width.container"}}}}}, {"id": "LWK8V4QpiRSR", "data": {"speed": "normal", "slides": [{"id": "bW1wk9e6IlBO", "data": [], "type": "rich_text"}]}, "type": "carousel"}, {"id": "3f0oMrrGiJ3U", "data": {"gap": 12, "margin": {"top": 8, "bottom": 8}, "radius": {"top": 12, "left": 12, "right": 12, "bottom": 12}, "shadow": "md", "content": [{"id": "uJnpKxx1m7oT", "data": {"margin": "small", "shadow": "lg", "content": [{"id": "evEAq8xX7U8j", "data": {"text": "Nested", "level": "h3"}, "type": "heading", "settings": {"style": {"alignment": {"text": {"base": {"type": "choice", "value": "center"}}}}}}], "padding": "medium", "class_hook": "promo", "shadow_color": "#123456", "shadow_opacity": 40}, "type": "style"}], "padding": {"top": 17, "left": 17, "right": 17, "bottom": 17}, "max_width": 900, "min_height": "half", "border_color": "#123456", "border_style": "solid", "border_width": 2, "min_height_px": 420, "overlay_color": "#000000", "padding_preset": "large", "overlay_opacity": 40, "background_color": "#f0f0f0"}, "type": "container"}], "title": "Published beta again", "_schema": {"settings": 1, "conversions": ["presentation-group-1"]}}	1	user00000001	2026-09-14 07:35:13.602769
\.
...
--
-- Data for Name: gateway_subscriptions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.gateway_subscriptions (id, uuid, tenant_uuid, gateway, gateway_subscription_id, gateway_customer_id, gateway_price_id, billing_plan_uuid, status, current_period_start, current_period_end, cancel_at_period_end, canceled_at, metadata, raw_payload, created_at, updated_at) FROM stdin;
\.
...
COPY public.invoices (id, uuid, tenant_uuid, user_uuid, billing_plan_uuid, payable_type, payable_id, number, amount, currency, status, due_at, paid_at, metadata, created_at, updated_at) FROM stdin;
\.
...
95	017_StyleColumnsOnBlockTypes.php	2	2026-09-14 11:25:00.325821	3dbc349f8ef45a2e2abc16058ac692c7c0e433544bd752d1c84582f68efa761a	Block types declare style capabilities, targets, flags and starter content	migrations	glueful/thallo-core
96	023_SchemaStampOnRegions.php	2	2026-09-14 11:25:00.339233	6d8ff5883cd53373e2d6ab7a46e4665203d3f0a69252b516cacb7166ee7839f8	Regions carry the settings schema stamp	migrations	glueful/thallo-core
97	001_CreateCommerceCatalogTables.php	2	2026-09-14 11:25:00.342953	7bbaf95d15e00e6a98defc1fb677af77fc7cde1c71cb3ec9437d05b5a68dd323	Creates commerce products and variants.	migrations	glueful/commerce
98	001_CreatePaymentsTable.php	2	2026-09-14 11:25:00.361176	358888e968c4a802a3e7f761810abf9871746362222bed6cf5941f53d19b4eba	Creates payments table for external payment providers with reconciliation metadata.	migrations	glueful/payvia
99	002_CreateBillingPlansTable.php	2	2026-09-14 11:25:00.373351	314ec92f918e8c1f2976ca5476456a518b69c3d2cca35ebaa2e492b04ea15ced	Creates billing_plans table for generic billing/subscription plans.	migrations	glueful/payvia
100	002_CreateCommerceInventoryTables.php	2	2026-09-14 11:25:00.379785	b8fad03c79b91ea8ddd396581da3eaff875db5d1c9ab14adb9a6cafbf560d897	Creates commerce stock and stock movement tables.	migrations	glueful/commerce
101	003_CreateCommerceCartTables.php	2	2026-09-14 11:25:00.388731	91448e9dfc3129f5a1ecc39458a60fa3efc99d2ceb251ddde61d0dd8c349d06d	Creates commerce cart and cart line tables.	migrations	glueful/commerce
102	003_CreateInvoicesTable.php	2	2026-09-14 11:25:00.400593	1e200818a6027a4f9a3fde47348f81d6360e47fe99c83dee121320f8dc8aa0f1	Creates invoices table for generic billing invoices with polymorphic links.	migrations	glueful/payvia
103	004_CreateCommerceOrderTables.php	2	2026-09-14 11:25:00.412247	b62225da13ba0f6cae6396b7c21e81954101f1883432378ce639191239238276	Creates commerce orders, order lines, audit events, and sequences.	migrations	glueful/commerce
104	004_CreateProviderEventsTable.php	2	2026-09-14 11:25:00.429807	35f02b8e1f8d362564d563c18e146b9bef2cec5db1c38ff095de78a5e224aa36	Creates provider_events for two-key idempotency and outbox dispatch.	migrations	glueful/payvia
105	005_CreateCommerceDiscountTables.php	2	2026-09-14 11:25:00.43469	41a487a00d00531d60bbdcd94f4e54cbf9e71ffa6077fffd6d0e1eab4ee7d834	Creates commerce discounts and discount redemption tables.	migrations	glueful/commerce
106	005_CreateGatewaySubscriptionsTable.php	2	2026-09-14 11:25:00.441593	b9ee6650ef11ffa5c2c4253cac20fde9f5972433bb3c5d386870b521c5a9f0a4	Creates persisted gateway subscription projection table.	migrations	glueful/payvia
107	006_AddProviderEventsDispatchIndex.php	2	2026-09-14 11:25:00.44774	df4ecdbab49abbcaf049bdd5e0a8543ef028ac0bcb85d8ddae42fba9f1505fdc	Adds composite (status, dispatch_status, dispatch_claimed_at) index to provider_events for the relay dispatch hot path.	migrations	glueful/payvia
108	006_CreateCommerceRefundTables.php	2	2026-09-14 11:25:00.450791	83c5e62dd1debbcb1162cd404a9b2e8fc034a80b71cf8ddbc9e90ea15521d90c	Creates commerce refunds and refund line tables.	migrations	glueful/commerce
109	007_CreateCommerceCatalogBreadthTables.php	2	2026-09-14 11:25:00.458519	1db0523ec854b6c0637e0145b057dd4cc0c2a8f5e393c9c6377faa0f147d0064	Creates commerce catalog breadth tables: media, categories, tags, attributes, product children, add-ons, and reviews.	migrations	glueful/commerce
110	007_CreatePaymentIntentsTable.php	2	2026-09-14 11:25:00.489753	1f95d91ac92bbcbb791a73c6e26c2bd38298ea57878d0f7db5f289fc03a29d8e	Creates payment intent records for idempotent hosted payment initiation.	migrations	glueful/payvia
111	008_CreateCommerceCustomerDeliveryTables.php	2	2026-09-14 11:25:00.495684	6368ea939d51ec3120534125643d6a3835fb4a7eae39d382acb3b58147f99984	Creates commerce customer address book, address, download definition, and download grant tables.	migrations	glueful/commerce
112	008_CreatePayviaTransfersTable.php	2	2026-09-14 11:25:00.510007	f3aa009c75889c596fa03ae58f9fc9fd1fe1c00ca70fc26bd652b26a4fc56575	Creates payvia_transfers: durable pre-I/O provider payout transfer attempts.	migrations	glueful/payvia
113	009_AddProviderEventDispatchClaimToken.php	2	2026-09-14 11:25:00.516731	00f65ad97a7c97e88e942e39709fb4ba63bc79c564cf55a6f30e6de75e90dc41	Adds nullable dispatch_claim_token to provider_events for owner-fenced dispatch leases.	migrations	glueful/payvia
114	009_CreateCommerceShippingTaxTables.php	2	2026-09-14 11:25:00.52092	fe8f33398c7e5d8fdf6bfca9e34e794ee13aec221c1436b52d73e108d33724e6	Creates commerce shipping zones, zone locations, shipping methods, shipping classes, and tax rate tables.	migrations	glueful/commerce
115	010_CreateCheckoutOriginations.php	2	2026-09-14 11:25:00.535489	64c64783de782c33443ecd9d6ef7f274529632b65e4f475a460d0f4456e197c3	Creates the checkout origination ledger and subject guard tables.	migrations	glueful/payvia
116	010_CreateMarketplaceSellerTables.php	2	2026-09-14 11:25:00.545804	cc31cc7bc6ae8b0bb47182968c864046562717feba72c642d2c52a684457f04c	Creates marketplace settings, sellers, and seller membership tables (MV1 foundation).	migrations	glueful/commerce
117	011_AddCheckoutOriginationReconciliationColumns.php	2	2026-09-14 11:25:00.556236	6a951a99f5027530da03afa74c8ba6fd36584d7024525003834f6c4f6b69da6c	Adds reconciliation_resolution/reconciliation_note/reconciled_at to subscription_checkout_originations for operator reconciliation (design spec §3.8).	migrations	glueful/payvia
118	011_CreateSellerOrderTables.php	2	2026-09-14 11:25:00.561466	e2a4c27ea76efc7ce23acab2f907176a0727cdc62cfed1c421a4764395a1b2c7	Creates the commerce_seller_orders table for MV2 shared-checkout seller partitions.	migrations	glueful/commerce
119	012_AddPaymentIntentAttemptLifecycle.php	2	2026-09-14 11:25:00.574268	177665fff3bb637c844b9ed0acdec92ba3827cfd06ee165774629bf8f2d57084	Resolves any pre-existing duplicate (tenant_uuid, gateway, reference) rows, then adds that portable UNIQUE (multiple NULLs permitted) to payment_intents for reference-addressable session attempts.	migrations	glueful/payvia
120	012_CreateMarketplaceLedgerTables.php	2	2026-09-14 11:25:00.575112	b5e157c0cc7c62b42928427e23331af2e85beb15682727158fbcb2ffc484761e	Creates the marketplace settlement ledger, account-posting locks, and commission-policy audit event tables (MV3 foundation).	migrations	glueful/commerce
121	013_CreatePayoutTable.php	2	2026-09-14 11:25:00.586596	4388f632ffb1b5ace6547f34abfd97cc3cf2911ec923f7595ec1a24ae8fed822	Creates the commerce_payouts table for MV3 manual and MV4 provider payouts.	migrations	glueful/commerce
122	014_CreateSellerPayoutAccountsTable.php	2	2026-09-14 11:25:00.592251	a42f4e1df321c8a689dd2ea38aece982651818f16433201a32c6559fa935378f	Creates the commerce_seller_payout_accounts table for MV4 provider payout destinations.	migrations	glueful/commerce
123	015_CreateSellerReservesTable.php	2	2026-09-14 11:25:00.596868	4b9866b2771f9636349320d4f0d77f66376ad74946e082f59c91b8733dea146b	Creates the commerce_seller_reserves and commerce_reserve_policy_events tables for MV5a rolling reserves.	migrations	glueful/commerce
124	016_CreateChargebacksTable.php	2	2026-09-14 11:25:00.604792	91e774ead77dcaa9a0466c51e49c67cfbfd56c2b6fbc0e533bfff8b8325e1360	Creates the commerce_chargebacks and commerce_chargeback_lines tables for MV5a chargebacks.	migrations	glueful/commerce
125	017_CreateSellerLifecycleEventsTable.php	2	2026-09-14 11:25:00.611957	71ab911ddc6ff9a173c3ef8a6ed21be41877f792c650ada599a062d9d3ff4bf1	Creates the commerce_seller_lifecycle_events table for MV5b seller-lifecycle audit.	migrations	glueful/commerce
126	018_CreateSellerApiKeysTables.php	2	2026-09-14 11:25:00.615862	bb3a8c92284d91f1759739505dd275c63390801bdad9ccf053b2e6103d774be4	Creates the commerce_seller_api_keys, commerce_seller_api_key_credentials, and commerce_seller_api_key_events tables for MV5c-1 seller API keys.	migrations	glueful/commerce
127	019_CreateSellerWebhookTables.php	2	2026-09-14 11:25:00.626979	a2a5420fe98764740a59a499fe48e61acba4f74b629f2689a6b20d3363bdb5f0	Creates the commerce_seller_webhook_endpoints, commerce_seller_webhook_secrets, commerce_seller_webhook_events, commerce_seller_webhook_deliveries, and commerce_seller_webhook_endpoint_events tables for MV5c-2 seller outbound webhooks.	migrations	glueful/commerce
128	020_CreateWishlistTables.php	2	2026-09-14 11:25:00.643805	231f856c8e573e6d941d36d32fc6b11c3e4fed9f8621c020f407f197e4fd2259	Creates the account-backed wishlist tables (commerce_wishlists, commerce_wishlist_items).	migrations	glueful/commerce
129	021_EnforceStockQuantityTrackedNotNull.php	2	2026-09-14 11:25:00.650545	c37a1672e6497d98791fbf57264be7892139bcffe0bfc49b4cb0bbe32c788099	Backfills NULL commerce_stock.quantity/tracked to their existing runtime defaults (0 / false) and constrains both columns NOT NULL.	migrations	glueful/commerce
130	022_AddWalkInOrderFieldsAndDraftAttemptLedger.php	2	2026-09-14 11:25:00.668028	48773bf7b557627abcaedb33daa1d1415c192b560874820cf8cdcd23655dd15c	Adds walk-in customer/fulfillment columns and draft_revision to commerce_orders (with order_number/email/guest_token_hash relaxed to nullable), and creates the commerce_order_draft_attempts finalize-idempotency ledger.	migrations	glueful/commerce
131	023_CreatePaymentLinksTable.php	2	2026-09-14 11:25:00.693578	6546ce84ca35146924c5feaee61ef2f4c60057753b97f27e054392dcfef61a32	Creates the commerce_payment_links table: hashed payment-link custody, closed status domain, fixed-UTC-hour initiation counter, and the provider-session exposure stamp.	migrations	glueful/commerce
\.
...
COPY public.payment_intents (id, uuid, tenant_uuid, payable_type, payable_id, idempotency_key, gateway, reference, status, amount, currency, payload, created_at, updated_at) FROM stdin;
\.
...
COPY public.payments (id, uuid, tenant_uuid, user_uuid, payable_type, payable_id, gateway, gateway_transaction_id, reference, amount, currency, status, message, metadata, raw_payload, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: payvia_transfers; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.payvia_transfers (id, uuid, tenant_uuid, gateway, idempotency_key, provider_reference, provider_ref, destination_ref, amount, currency, status, message, request_payload, raw_payload, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: provider_events; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.provider_events (id, uuid, gateway, source, provider_event_id, delivery_key, logical_event_key, type, status, dispatch_status, dispatched_at, dispatch_claimed_at, attempts, signature_valid, normalized_payload, raw_payload, error, received_at, processed_at, dispatch_claim_token) FROM stdin;
\.
...
COPY public.regions (slug, blocks, settings, updated_at, updated_by, schema_stamp) FROM stdin;
footer	[{"id": "v0LjUDCEWOMO", "data": {"content": "<p>Footer</p>"}, "type": "rich_text"}]	{"width": "contained"}	2026-09-14 11:25:03	user00000001	{"settings": 1, "conversions": ["presentation-group-1"]}
header	[{"id": "l9AsUW4sH7OO", "data": {"content": [{"id": "NJLg85eHsdJM", "data": {"url": "/docs", "label": "Docs"}, "type": "button", "settings": {"style": {"radius": {"type": "token", "value": "radius.full"}}}}], "padding_preset": "small", "background_color": "#ffffff"}, "type": "container"}]	{"width": "contained", "sticky": true}	2026-09-14 11:25:03	user00000001	{"settings": 1, "conversions": ["presentation-group-1"]}
\.
...
--
-- Data for Name: subscription_checkout_originations; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.subscription_checkout_originations (id, uuid, tenant_uuid, subject_key, gateway, provider_plan_identifier, idempotency_key, request_fingerprint, initialization_claim_token, initialization_claimed_at, customer_email, return_url, cancel_url, checkout_reference, checkout_url, provider_subscription_id, provider_customer_code, provider_plan_code, status, live, required_projection_consumer, projection_event_key, projection_outcome, projection_reason, consumer_metadata, provider_expires_at, created_at, updated_at, reconciliation_resolution, reconciliation_note, reconciled_at) FROM stdin;
\.


--
-- Data for Name: subscription_checkout_subject_guards; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.subscription_checkout_subject_guards (id, uuid, tenant_uuid, subject_key, state, origination_uuid, blocked_reason, revision, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: commerce_attribute_values_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_attribute_values_id_seq', 1, false);


--
-- Name: commerce_attributes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_attributes_id_seq', 1, false);


--
-- Name: commerce_cart_lines_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_cart_lines_id_seq', 1, false);


--
-- Name: commerce_carts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_carts_id_seq', 1, false);


--
-- Name: commerce_categories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_categories_id_seq', 1, false);


--
-- Name: commerce_chargeback_lines_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_chargeback_lines_id_seq', 1, false);


--
-- Name: commerce_chargebacks_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_chargebacks_id_seq', 1, false);


--
-- Name: commerce_commission_policy_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_commission_policy_events_id_seq', 1, false);


--
-- Name: commerce_customer_address_books_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_customer_address_books_id_seq', 1, false);


--
-- Name: commerce_customer_addresses_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_customer_addresses_id_seq', 1, false);


--
-- Name: commerce_discount_redemptions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_discount_redemptions_id_seq', 1, false);
...
--
-- Name: commerce_download_grants_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_download_grants_id_seq', 1, false);


--
-- Name: commerce_downloads_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_downloads_id_seq', 1, false);


--
-- Name: commerce_ledger_account_locks_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_ledger_account_locks_id_seq', 1, false);


--
-- Name: commerce_marketplace_ledger_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_marketplace_ledger_id_seq', 1, false);


--
-- Name: commerce_marketplace_settings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_marketplace_settings_id_seq', 1, false);


--
-- Name: commerce_order_draft_attempts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_order_draft_attempts_id_seq', 1, false);


--
-- Name: commerce_order_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_order_events_id_seq', 1, false);


--
-- Name: commerce_order_lines_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_order_lines_id_seq', 1, false);


--
-- Name: commerce_orders_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_orders_id_seq', 1, false);


--
-- Name: commerce_payment_links_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_payment_links_id_seq', 1, false);


--
-- Name: commerce_payouts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_payouts_id_seq', 1, false);


--
-- Name: commerce_product_addons_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_product_addons_id_seq', 1, false);


--
-- Name: commerce_product_attributes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_product_attributes_id_seq', 1, false);


--
-- Name: commerce_product_categories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_product_categories_id_seq', 1, false);


--
-- Name: commerce_product_children_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_product_children_id_seq', 1, false);


--
-- Name: commerce_product_media_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_product_media_id_seq', 1, false);


--
-- Name: commerce_product_tags_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_product_tags_id_seq', 1, false);


--
-- Name: commerce_products_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_products_id_seq', 1, false);


--
-- Name: commerce_refund_lines_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_refund_lines_id_seq', 1, false);


--
-- Name: commerce_refunds_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_refunds_id_seq', 1, false);


--
-- Name: commerce_reserve_policy_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_reserve_policy_events_id_seq', 1, false);


--
-- Name: commerce_reviews_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_reviews_id_seq', 1, false);


--
-- Name: commerce_seller_api_key_credentials_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_api_key_credentials_id_seq', 1, false);


--
-- Name: commerce_seller_api_key_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_api_key_events_id_seq', 1, false);


--
-- Name: commerce_seller_api_keys_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_api_keys_id_seq', 1, false);


--
-- Name: commerce_seller_lifecycle_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_lifecycle_events_id_seq', 1, false);


--
-- Name: commerce_seller_memberships_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_memberships_id_seq', 1, false);


--
-- Name: commerce_seller_orders_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_orders_id_seq', 1, false);


--
-- Name: commerce_seller_payout_accounts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_payout_accounts_id_seq', 1, false);


--
-- Name: commerce_seller_reserves_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_reserves_id_seq', 1, false);


--
-- Name: commerce_seller_webhook_deliveries_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_webhook_deliveries_id_seq', 1, false);


--
-- Name: commerce_seller_webhook_endpoint_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_webhook_endpoint_events_id_seq', 1, false);


--
-- Name: commerce_seller_webhook_endpoints_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_webhook_endpoints_id_seq', 1, false);


--
-- Name: commerce_seller_webhook_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_webhook_events_id_seq', 1, false);


--
-- Name: commerce_seller_webhook_secrets_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_seller_webhook_secrets_id_seq', 1, false);


--
-- Name: commerce_sellers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_sellers_id_seq', 1, false);


--
-- Name: commerce_sequences_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_sequences_id_seq', 1, false);


--
-- Name: commerce_shipping_classes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_shipping_classes_id_seq', 1, false);


--
-- Name: commerce_shipping_methods_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_shipping_methods_id_seq', 1, false);


--
-- Name: commerce_shipping_zone_locations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_shipping_zone_locations_id_seq', 1, false);


--
-- Name: commerce_shipping_zones_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_shipping_zones_id_seq', 1, false);


--
-- Name: commerce_stock_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_stock_id_seq', 1, false);


--
-- Name: commerce_stock_movements_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_stock_movements_id_seq', 1, false);


--
-- Name: commerce_tags_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_tags_id_seq', 1, false);


--
-- Name: commerce_tax_rates_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_tax_rates_id_seq', 1, false);


--
-- Name: commerce_variants_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_variants_id_seq', 1, false);


--
-- Name: commerce_wishlist_items_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_wishlist_items_id_seq', 1, false);


--
-- Name: commerce_wishlists_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.commerce_wishlists_id_seq', 1, false);
...
--
-- Name: gateway_subscriptions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: payvia_transfers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.payvia_transfers_id_seq', 1, false);
...
--
-- Name: provider_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.provider_events_id_seq', 1, false);
...
--
-- Name: subscription_checkout_originations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.subscription_checkout_originations_id_seq', 1, false);


--
-- Name: subscription_checkout_subject_guards_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.subscription_checkout_subject_guards_id_seq', 1, false);
...
--
-- Name: billing_plans billing_plans_tenant_uuid_gateway_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.billing_plans
    ADD CONSTRAINT billing_plans_tenant_uuid_gateway_name_unique UNIQUE (tenant_uuid, gateway, name);


--
-- Name: billing_plans billing_plans_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.billing_plans
    ADD CONSTRAINT billing_plans_uuid_unique UNIQUE (uuid);
...
--
-- Name: commerce_attribute_values commerce_attribute_values_attribute_uuid_slug_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_attribute_values
    ADD CONSTRAINT commerce_attribute_values_attribute_uuid_slug_unique UNIQUE (attribute_uuid, slug);


--
-- Name: commerce_attribute_values commerce_attribute_values_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_attribute_values
    ADD CONSTRAINT commerce_attribute_values_pkey PRIMARY KEY (id);


--
-- Name: commerce_attribute_values commerce_attribute_values_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_attribute_values
    ADD CONSTRAINT commerce_attribute_values_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_attributes commerce_attributes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_attributes
    ADD CONSTRAINT commerce_attributes_pkey PRIMARY KEY (id);


--
-- Name: commerce_attributes commerce_attributes_tenant_uuid_slug_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_attributes
    ADD CONSTRAINT commerce_attributes_tenant_uuid_slug_unique UNIQUE (tenant_uuid, slug);


--
-- Name: commerce_attributes commerce_attributes_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_attributes
    ADD CONSTRAINT commerce_attributes_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_cart_lines commerce_cart_lines_cart_uuid_variant_uuid_addons_hash_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_cart_lines
    ADD CONSTRAINT commerce_cart_lines_cart_uuid_variant_uuid_addons_hash_unique UNIQUE (cart_uuid, variant_uuid, addons_hash);


--
-- Name: commerce_cart_lines commerce_cart_lines_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_cart_lines
    ADD CONSTRAINT commerce_cart_lines_pkey PRIMARY KEY (id);


--
-- Name: commerce_cart_lines commerce_cart_lines_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_cart_lines
    ADD CONSTRAINT commerce_cart_lines_uuid_unique UNIQUE (uuid);
...
--
-- Name: commerce_carts commerce_carts_tenant_uuid_token_hash_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_carts
    ADD CONSTRAINT commerce_carts_tenant_uuid_token_hash_unique UNIQUE (tenant_uuid, token_hash);


--
-- Name: commerce_carts commerce_carts_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_carts
    ADD CONSTRAINT commerce_carts_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_categories commerce_categories_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commerce_categories commerce_categories_tenant_uuid_slug_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_categories
    ADD CONSTRAINT commerce_categories_tenant_uuid_slug_unique UNIQUE (tenant_uuid, slug);


--
-- Name: commerce_categories commerce_categories_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_categories
    ADD CONSTRAINT commerce_categories_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_chargeback_lines commerce_chargeback_lines_chargeback_order_line_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_chargeback_lines
    ADD CONSTRAINT commerce_chargeback_lines_chargeback_order_line_unique UNIQUE (tenant_uuid, chargeback_uuid, order_line_uuid);


--
-- Name: commerce_chargeback_lines commerce_chargeback_lines_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_chargeback_lines
    ADD CONSTRAINT commerce_chargeback_lines_pkey PRIMARY KEY (id);


--
-- Name: commerce_chargeback_lines commerce_chargeback_lines_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_chargeback_lines
    ADD CONSTRAINT commerce_chargeback_lines_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_chargebacks commerce_chargebacks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_chargebacks
    ADD CONSTRAINT commerce_chargebacks_pkey PRIMARY KEY (id);


--
-- Name: commerce_chargebacks commerce_chargebacks_provider_event_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_chargebacks
    ADD CONSTRAINT commerce_chargebacks_provider_event_unique UNIQUE (tenant_uuid, provider, provider_event_id);


--
-- Name: commerce_commission_policy_events commerce_commission_policy_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_commission_policy_events
    ADD CONSTRAINT commerce_commission_policy_events_pkey PRIMARY KEY (id);


--
-- Name: commerce_commission_policy_events commerce_commission_policy_events_tenant_uuid_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_commission_policy_events
    ADD CONSTRAINT commerce_commission_policy_events_tenant_uuid_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_customer_address_books commerce_customer_address_books_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_customer_address_books
    ADD CONSTRAINT commerce_customer_address_books_pkey PRIMARY KEY (id);


--
-- Name: commerce_customer_address_books commerce_customer_address_books_tenant_uuid_user_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_customer_address_books
    ADD CONSTRAINT commerce_customer_address_books_tenant_uuid_user_uuid_unique UNIQUE (tenant_uuid, user_uuid);


--
-- Name: commerce_customer_address_books commerce_customer_address_books_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_customer_address_books
    ADD CONSTRAINT commerce_customer_address_books_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_customer_addresses commerce_customer_addresses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_customer_addresses
    ADD CONSTRAINT commerce_customer_addresses_pkey PRIMARY KEY (id);


--
-- Name: commerce_customer_addresses commerce_customer_addresses_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_customer_addresses
    ADD CONSTRAINT commerce_customer_addresses_uuid_unique UNIQUE (uuid);
...
--
-- Name: commerce_discount_redemptions commerce_discount_redemptions_tenant_uuid_discount_uuid_buyer_k; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_discount_redemptions
    ADD CONSTRAINT commerce_discount_redemptions_tenant_uuid_discount_uuid_buyer_k UNIQUE (tenant_uuid, discount_uuid, buyer_key);


--
-- Name: commerce_discount_redemptions commerce_discount_redemptions_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_discount_redemptions
    ADD CONSTRAINT commerce_discount_redemptions_uuid_unique UNIQUE (uuid);
...
--
-- Name: commerce_discounts commerce_discounts_tenant_uuid_code_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_discounts
    ADD CONSTRAINT commerce_discounts_tenant_uuid_code_unique UNIQUE (tenant_uuid, code);


--
-- Name: commerce_discounts commerce_discounts_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_discounts
    ADD CONSTRAINT commerce_discounts_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_download_grants commerce_download_grants_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_download_grants
    ADD CONSTRAINT commerce_download_grants_pkey PRIMARY KEY (id);


--
-- Name: commerce_download_grants commerce_download_grants_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_download_grants
    ADD CONSTRAINT commerce_download_grants_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_downloads commerce_downloads_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_downloads
    ADD CONSTRAINT commerce_downloads_pkey PRIMARY KEY (id);


--
-- Name: commerce_downloads commerce_downloads_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_downloads
    ADD CONSTRAINT commerce_downloads_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_downloads commerce_downloads_variant_uuid_blob_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_downloads
    ADD CONSTRAINT commerce_downloads_variant_uuid_blob_uuid_unique UNIQUE (variant_uuid, blob_uuid);


--
-- Name: commerce_ledger_account_locks commerce_ledger_account_locks_key_currency_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_ledger_account_locks
    ADD CONSTRAINT commerce_ledger_account_locks_key_currency_unique UNIQUE (tenant_uuid, account_key, currency);


--
-- Name: commerce_ledger_account_locks commerce_ledger_account_locks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_ledger_account_locks
    ADD CONSTRAINT commerce_ledger_account_locks_pkey PRIMARY KEY (id);


--
-- Name: commerce_marketplace_ledger commerce_marketplace_ledger_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_marketplace_ledger
    ADD CONSTRAINT commerce_marketplace_ledger_pkey PRIMARY KEY (id);


--
-- Name: commerce_marketplace_ledger commerce_marketplace_ledger_tenant_uuid_idempotency_key_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_marketplace_ledger
    ADD CONSTRAINT commerce_marketplace_ledger_tenant_uuid_idempotency_key_unique UNIQUE (tenant_uuid, idempotency_key);


--
-- Name: commerce_marketplace_settings commerce_marketplace_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_marketplace_settings
    ADD CONSTRAINT commerce_marketplace_settings_pkey PRIMARY KEY (id);


--
-- Name: commerce_marketplace_settings commerce_marketplace_settings_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_marketplace_settings
    ADD CONSTRAINT commerce_marketplace_settings_tenant_uuid_unique UNIQUE (tenant_uuid);


--
-- Name: commerce_marketplace_settings commerce_marketplace_settings_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_marketplace_settings
    ADD CONSTRAINT commerce_marketplace_settings_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_order_draft_attempts commerce_order_draft_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_order_draft_attempts
    ADD CONSTRAINT commerce_order_draft_attempts_pkey PRIMARY KEY (id);


--
-- Name: commerce_order_draft_attempts commerce_order_draft_attempts_tenant_uuid_idempotency_key_uniqu; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_order_draft_attempts
    ADD CONSTRAINT commerce_order_draft_attempts_tenant_uuid_idempotency_key_uniqu UNIQUE (tenant_uuid, idempotency_key);
...
--
-- Name: commerce_order_events commerce_order_events_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_order_events
    ADD CONSTRAINT commerce_order_events_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_order_lines commerce_order_lines_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commerce_order_lines commerce_order_lines_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_order_lines
    ADD CONSTRAINT commerce_order_lines_uuid_unique UNIQUE (uuid);
...
--
-- Name: commerce_orders commerce_orders_tenant_uuid_order_number_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_orders
    ADD CONSTRAINT commerce_orders_tenant_uuid_order_number_unique UNIQUE (tenant_uuid, order_number);


--
-- Name: commerce_orders commerce_orders_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_orders
    ADD CONSTRAINT commerce_orders_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_payment_links commerce_payment_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_payment_links
    ADD CONSTRAINT commerce_payment_links_pkey PRIMARY KEY (id);


--
-- Name: commerce_payment_links commerce_payment_links_tenant_token_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_payment_links
    ADD CONSTRAINT commerce_payment_links_tenant_token_unique UNIQUE (tenant_uuid, token_hash);


--
-- Name: commerce_payment_links commerce_payment_links_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_payment_links
    ADD CONSTRAINT commerce_payment_links_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_payout_accounts commerce_payout_accounts_tenant_seller_provider_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_payout_accounts
    ADD CONSTRAINT commerce_payout_accounts_tenant_seller_provider_unique UNIQUE (tenant_uuid, seller_uuid, provider);


--
-- Name: commerce_seller_payout_accounts commerce_payout_accounts_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_payout_accounts
    ADD CONSTRAINT commerce_payout_accounts_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_payouts commerce_payouts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_payouts
    ADD CONSTRAINT commerce_payouts_pkey PRIMARY KEY (id);


--
-- Name: commerce_payouts commerce_payouts_tenant_uuid_idempotency_key_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_payouts
    ADD CONSTRAINT commerce_payouts_tenant_uuid_idempotency_key_unique UNIQUE (tenant_uuid, idempotency_key);


--
-- Name: commerce_payouts commerce_payouts_tenant_uuid_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_payouts
    ADD CONSTRAINT commerce_payouts_tenant_uuid_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_product_addons commerce_product_addons_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_addons
    ADD CONSTRAINT commerce_product_addons_pkey PRIMARY KEY (id);


--
-- Name: commerce_product_addons commerce_product_addons_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_addons
    ADD CONSTRAINT commerce_product_addons_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_product_attributes commerce_product_attributes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_attributes
    ADD CONSTRAINT commerce_product_attributes_pkey PRIMARY KEY (id);


--
-- Name: commerce_product_attributes commerce_product_attributes_product_uuid_attribute_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_attributes
    ADD CONSTRAINT commerce_product_attributes_product_uuid_attribute_uuid_unique UNIQUE (product_uuid, attribute_uuid);


--
-- Name: commerce_product_attributes commerce_product_attributes_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_attributes
    ADD CONSTRAINT commerce_product_attributes_uuid_unique UNIQUE (uuid);
...
--
-- Name: commerce_product_categories commerce_product_categories_product_uuid_category_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_categories
    ADD CONSTRAINT commerce_product_categories_product_uuid_category_uuid_unique UNIQUE (product_uuid, category_uuid);


--
-- Name: commerce_product_children commerce_product_children_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_children
    ADD CONSTRAINT commerce_product_children_pkey PRIMARY KEY (id);


--
-- Name: commerce_product_children commerce_product_children_product_uuid_child_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_children
    ADD CONSTRAINT commerce_product_children_product_uuid_child_uuid_unique UNIQUE (product_uuid, child_uuid);
...
--
-- Name: commerce_product_media commerce_product_media_product_uuid_blob_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_media
    ADD CONSTRAINT commerce_product_media_product_uuid_blob_uuid_unique UNIQUE (product_uuid, blob_uuid);


--
-- Name: commerce_product_media commerce_product_media_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_media
    ADD CONSTRAINT commerce_product_media_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_product_tags commerce_product_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_tags
    ADD CONSTRAINT commerce_product_tags_pkey PRIMARY KEY (id);


--
-- Name: commerce_product_tags commerce_product_tags_product_uuid_tag_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_product_tags
    ADD CONSTRAINT commerce_product_tags_product_uuid_tag_uuid_unique UNIQUE (product_uuid, tag_uuid);
...
--
-- Name: commerce_products commerce_products_tenant_uuid_slug_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_products
    ADD CONSTRAINT commerce_products_tenant_uuid_slug_unique UNIQUE (tenant_uuid, slug);


--
-- Name: commerce_products commerce_products_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_products
    ADD CONSTRAINT commerce_products_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_refund_lines commerce_refund_lines_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_refund_lines
    ADD CONSTRAINT commerce_refund_lines_pkey PRIMARY KEY (id);


--
-- Name: commerce_refund_lines commerce_refund_lines_refund_uuid_order_line_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_refund_lines
    ADD CONSTRAINT commerce_refund_lines_refund_uuid_order_line_uuid_unique UNIQUE (refund_uuid, order_line_uuid);
...
--
-- Name: commerce_refunds commerce_refunds_tenant_uuid_idempotency_key_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_refunds
    ADD CONSTRAINT commerce_refunds_tenant_uuid_idempotency_key_unique UNIQUE (tenant_uuid, idempotency_key);


--
-- Name: commerce_refunds commerce_refunds_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_refunds
    ADD CONSTRAINT commerce_refunds_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_reserve_policy_events commerce_reserve_policy_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_reserve_policy_events
    ADD CONSTRAINT commerce_reserve_policy_events_pkey PRIMARY KEY (id);


--
-- Name: commerce_reserve_policy_events commerce_reserve_policy_events_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_reserve_policy_events
    ADD CONSTRAINT commerce_reserve_policy_events_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_reviews commerce_reviews_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_reviews
    ADD CONSTRAINT commerce_reviews_pkey PRIMARY KEY (id);


--
-- Name: commerce_reviews commerce_reviews_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_reviews
    ADD CONSTRAINT commerce_reviews_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_seller_api_key_credentials commerce_seller_api_key_credentials_framework_key_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_key_credentials
    ADD CONSTRAINT commerce_seller_api_key_credentials_framework_key_unique UNIQUE (tenant_uuid, framework_key_uuid);


--
-- Name: commerce_seller_api_key_credentials commerce_seller_api_key_credentials_lineage_generation_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_key_credentials
    ADD CONSTRAINT commerce_seller_api_key_credentials_lineage_generation_unique UNIQUE (tenant_uuid, lineage_uuid, generation);


--
-- Name: commerce_seller_api_key_credentials commerce_seller_api_key_credentials_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_key_credentials
    ADD CONSTRAINT commerce_seller_api_key_credentials_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_api_key_credentials commerce_seller_api_key_credentials_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_key_credentials
    ADD CONSTRAINT commerce_seller_api_key_credentials_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_api_key_events commerce_seller_api_key_events_dedupe_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_key_events
    ADD CONSTRAINT commerce_seller_api_key_events_dedupe_unique UNIQUE (tenant_uuid, lineage_uuid, action, reason_code, bucket_start);


--
-- Name: commerce_seller_api_key_events commerce_seller_api_key_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_key_events
    ADD CONSTRAINT commerce_seller_api_key_events_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_api_key_events commerce_seller_api_key_events_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_key_events
    ADD CONSTRAINT commerce_seller_api_key_events_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_api_keys commerce_seller_api_keys_current_credential_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_keys
    ADD CONSTRAINT commerce_seller_api_keys_current_credential_unique UNIQUE (tenant_uuid, current_credential_uuid);


--
-- Name: commerce_seller_api_keys commerce_seller_api_keys_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_keys
    ADD CONSTRAINT commerce_seller_api_keys_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_api_keys commerce_seller_api_keys_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_api_keys
    ADD CONSTRAINT commerce_seller_api_keys_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_lifecycle_events commerce_seller_lifecycle_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_lifecycle_events
    ADD CONSTRAINT commerce_seller_lifecycle_events_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_lifecycle_events commerce_seller_lifecycle_events_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_lifecycle_events
    ADD CONSTRAINT commerce_seller_lifecycle_events_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_memberships commerce_seller_memberships_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_memberships
    ADD CONSTRAINT commerce_seller_memberships_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_memberships commerce_seller_memberships_seller_uuid_user_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_memberships
    ADD CONSTRAINT commerce_seller_memberships_seller_uuid_user_uuid_unique UNIQUE (seller_uuid, user_uuid);


--
-- Name: commerce_seller_memberships commerce_seller_memberships_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_memberships
    ADD CONSTRAINT commerce_seller_memberships_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_seller_orders commerce_seller_orders_order_uuid_partition_number_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_orders
    ADD CONSTRAINT commerce_seller_orders_order_uuid_partition_number_unique UNIQUE (order_uuid, partition_number);


--
-- Name: commerce_seller_orders commerce_seller_orders_order_uuid_seller_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_orders
    ADD CONSTRAINT commerce_seller_orders_order_uuid_seller_uuid_unique UNIQUE (order_uuid, seller_uuid);


--
-- Name: commerce_seller_orders commerce_seller_orders_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_orders
    ADD CONSTRAINT commerce_seller_orders_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_orders commerce_seller_orders_tenant_uuid_seller_reference_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_orders
    ADD CONSTRAINT commerce_seller_orders_tenant_uuid_seller_reference_unique UNIQUE (tenant_uuid, seller_reference);


--
-- Name: commerce_seller_orders commerce_seller_orders_tenant_uuid_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_orders
    ADD CONSTRAINT commerce_seller_orders_tenant_uuid_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_payout_accounts commerce_seller_payout_accounts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_payout_accounts
    ADD CONSTRAINT commerce_seller_payout_accounts_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_reserves commerce_seller_reserves_idempotency_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_reserves
    ADD CONSTRAINT commerce_seller_reserves_idempotency_unique UNIQUE (tenant_uuid, idempotency_key);


--
-- Name: commerce_seller_reserves commerce_seller_reserves_order_seller_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_reserves
    ADD CONSTRAINT commerce_seller_reserves_order_seller_unique UNIQUE (tenant_uuid, seller_order_uuid, seller_uuid);


--
-- Name: commerce_seller_reserves commerce_seller_reserves_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_reserves
    ADD CONSTRAINT commerce_seller_reserves_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_reserves commerce_seller_reserves_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_reserves
    ADD CONSTRAINT commerce_seller_reserves_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_webhook_deliveries commerce_seller_webhook_deliveries_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_deliveries
    ADD CONSTRAINT commerce_seller_webhook_deliveries_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_webhook_endpoint_events commerce_seller_webhook_endpoint_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_endpoint_events
    ADD CONSTRAINT commerce_seller_webhook_endpoint_events_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_webhook_endpoint_events commerce_seller_webhook_endpoint_events_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_endpoint_events
    ADD CONSTRAINT commerce_seller_webhook_endpoint_events_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_webhook_endpoints commerce_seller_webhook_endpoints_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_endpoints
    ADD CONSTRAINT commerce_seller_webhook_endpoints_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_webhook_endpoints commerce_seller_webhook_endpoints_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_endpoints
    ADD CONSTRAINT commerce_seller_webhook_endpoints_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_webhook_events commerce_seller_webhook_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_events
    ADD CONSTRAINT commerce_seller_webhook_events_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_webhook_events commerce_seller_webhook_events_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_events
    ADD CONSTRAINT commerce_seller_webhook_events_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_seller_webhook_secrets commerce_seller_webhook_secrets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_secrets
    ADD CONSTRAINT commerce_seller_webhook_secrets_pkey PRIMARY KEY (id);


--
-- Name: commerce_seller_webhook_secrets commerce_seller_webhook_secrets_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_seller_webhook_secrets
    ADD CONSTRAINT commerce_seller_webhook_secrets_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_sellers commerce_sellers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_sellers
    ADD CONSTRAINT commerce_sellers_pkey PRIMARY KEY (id);


--
-- Name: commerce_sellers commerce_sellers_tenant_uuid_slug_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_sellers
    ADD CONSTRAINT commerce_sellers_tenant_uuid_slug_unique UNIQUE (tenant_uuid, slug);


--
-- Name: commerce_sellers commerce_sellers_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_sellers
    ADD CONSTRAINT commerce_sellers_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_sequences commerce_sequences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_sequences
    ADD CONSTRAINT commerce_sequences_pkey PRIMARY KEY (id);


--
-- Name: commerce_sequences commerce_sequences_tenant_uuid_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_sequences
    ADD CONSTRAINT commerce_sequences_tenant_uuid_name_unique UNIQUE (tenant_uuid, name);


--
-- Name: commerce_shipping_classes commerce_shipping_classes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_classes
    ADD CONSTRAINT commerce_shipping_classes_pkey PRIMARY KEY (id);


--
-- Name: commerce_shipping_classes commerce_shipping_classes_tenant_uuid_slug_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_classes
    ADD CONSTRAINT commerce_shipping_classes_tenant_uuid_slug_unique UNIQUE (tenant_uuid, slug);


--
-- Name: commerce_shipping_classes commerce_shipping_classes_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_classes
    ADD CONSTRAINT commerce_shipping_classes_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_shipping_methods commerce_shipping_methods_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_methods
    ADD CONSTRAINT commerce_shipping_methods_pkey PRIMARY KEY (id);


--
-- Name: commerce_shipping_methods commerce_shipping_methods_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_methods
    ADD CONSTRAINT commerce_shipping_methods_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_shipping_zone_locations commerce_shipping_zone_locations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_zone_locations
    ADD CONSTRAINT commerce_shipping_zone_locations_pkey PRIMARY KEY (id);


--
-- Name: commerce_shipping_zone_locations commerce_shipping_zone_locations_zone_uuid_kind_value_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_zone_locations
    ADD CONSTRAINT commerce_shipping_zone_locations_zone_uuid_kind_value_unique UNIQUE (zone_uuid, kind, value);


--
-- Name: commerce_shipping_zones commerce_shipping_zones_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_zones
    ADD CONSTRAINT commerce_shipping_zones_pkey PRIMARY KEY (id);


--
-- Name: commerce_shipping_zones commerce_shipping_zones_tenant_uuid_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_zones
    ADD CONSTRAINT commerce_shipping_zones_tenant_uuid_name_unique UNIQUE (tenant_uuid, name);


--
-- Name: commerce_shipping_zones commerce_shipping_zones_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_shipping_zones
    ADD CONSTRAINT commerce_shipping_zones_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_stock_movements commerce_stock_movements_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_stock_movements
    ADD CONSTRAINT commerce_stock_movements_pkey PRIMARY KEY (id);


--
-- Name: commerce_stock_movements commerce_stock_movements_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_stock_movements
    ADD CONSTRAINT commerce_stock_movements_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_stock commerce_stock_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_stock
    ADD CONSTRAINT commerce_stock_pkey PRIMARY KEY (id);


--
-- Name: commerce_stock commerce_stock_tenant_uuid_variant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_stock
    ADD CONSTRAINT commerce_stock_tenant_uuid_variant_uuid_unique UNIQUE (tenant_uuid, variant_uuid);


--
-- Name: commerce_stock commerce_stock_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_stock
    ADD CONSTRAINT commerce_stock_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_tags commerce_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_tags
    ADD CONSTRAINT commerce_tags_pkey PRIMARY KEY (id);


--
-- Name: commerce_tags commerce_tags_tenant_uuid_slug_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_tags
    ADD CONSTRAINT commerce_tags_tenant_uuid_slug_unique UNIQUE (tenant_uuid, slug);


--
-- Name: commerce_tags commerce_tags_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_tags
    ADD CONSTRAINT commerce_tags_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_tax_rates commerce_tax_rates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_tax_rates
    ADD CONSTRAINT commerce_tax_rates_pkey PRIMARY KEY (id);


--
-- Name: commerce_tax_rates commerce_tax_rates_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_tax_rates
    ADD CONSTRAINT commerce_tax_rates_uuid_unique UNIQUE (uuid);
...
--
-- Name: commerce_variants commerce_variants_tenant_uuid_sku_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_variants
    ADD CONSTRAINT commerce_variants_tenant_uuid_sku_unique UNIQUE (tenant_uuid, sku);


--
-- Name: commerce_variants commerce_variants_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_variants
    ADD CONSTRAINT commerce_variants_uuid_unique UNIQUE (uuid);


--
-- Name: commerce_wishlist_items commerce_wishlist_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_wishlist_items
    ADD CONSTRAINT commerce_wishlist_items_pkey PRIMARY KEY (id);


--
-- Name: commerce_wishlist_items commerce_wishlist_items_tenant_user_product_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_wishlist_items
    ADD CONSTRAINT commerce_wishlist_items_tenant_user_product_unique UNIQUE (tenant_uuid, user_uuid, product_uuid);


--
-- Name: commerce_wishlist_items commerce_wishlist_items_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_wishlist_items
    ADD CONSTRAINT commerce_wishlist_items_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);


--
-- Name: commerce_wishlists commerce_wishlists_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_wishlists
    ADD CONSTRAINT commerce_wishlists_pkey PRIMARY KEY (id);


--
-- Name: commerce_wishlists commerce_wishlists_tenant_user_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_wishlists
    ADD CONSTRAINT commerce_wishlists_tenant_user_unique UNIQUE (tenant_uuid, user_uuid);


--
-- Name: commerce_wishlists commerce_wishlists_tenant_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_wishlists
    ADD CONSTRAINT commerce_wishlists_tenant_uuid_unique UNIQUE (tenant_uuid, uuid);
...
--
-- Name: gateway_subscriptions gateway_subscriptions_gateway_gateway_subscription_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gateway_subscriptions
    ADD CONSTRAINT gateway_subscriptions_gateway_gateway_subscription_id_unique UNIQUE (gateway, gateway_subscription_id);


--
-- Name: gateway_subscriptions gateway_subscriptions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: gateway_subscriptions gateway_subscriptions_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.gateway_subscriptions
    ADD CONSTRAINT gateway_subscriptions_uuid_unique UNIQUE (uuid);
...
--
-- Name: invoices invoices_tenant_uuid_number_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.invoices
    ADD CONSTRAINT invoices_tenant_uuid_number_unique UNIQUE (tenant_uuid, number);


--
-- Name: invoices invoices_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.invoices
    ADD CONSTRAINT invoices_uuid_unique UNIQUE (uuid);
...
--
-- Name: payment_intents payment_intents_tenant_uuid_idempotency_key_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payment_intents
    ADD CONSTRAINT payment_intents_tenant_uuid_idempotency_key_unique UNIQUE (tenant_uuid, idempotency_key);


--
-- Name: payment_intents payment_intents_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payment_intents
    ADD CONSTRAINT payment_intents_uuid_unique UNIQUE (uuid);
...
--
-- Name: payments payments_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payvia_transfers payvia_transfers_gateway_provider_ref_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payvia_transfers
    ADD CONSTRAINT payvia_transfers_gateway_provider_ref_unique UNIQUE (gateway, provider_ref);


--
-- Name: payvia_transfers payvia_transfers_gateway_provider_reference_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payvia_transfers
    ADD CONSTRAINT payvia_transfers_gateway_provider_reference_unique UNIQUE (gateway, provider_reference);


--
-- Name: payvia_transfers payvia_transfers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payvia_transfers
    ADD CONSTRAINT payvia_transfers_pkey PRIMARY KEY (id);


--
-- Name: payvia_transfers payvia_transfers_tenant_uuid_gateway_idempotency_key_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payvia_transfers
    ADD CONSTRAINT payvia_transfers_tenant_uuid_gateway_idempotency_key_unique UNIQUE (tenant_uuid, gateway, idempotency_key);


--
-- Name: payvia_transfers payvia_transfers_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payvia_transfers
    ADD CONSTRAINT payvia_transfers_uuid_unique UNIQUE (uuid);
...
--
-- Name: provider_events provider_events_gateway_delivery_key_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.provider_events
    ADD CONSTRAINT provider_events_gateway_delivery_key_unique UNIQUE (gateway, delivery_key);
...
--
-- Name: provider_events provider_events_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.provider_events
    ADD CONSTRAINT provider_events_uuid_unique UNIQUE (uuid);
...
--
-- Name: subscription_checkout_originations subscription_checkout_originations_gateway_checkout_reference_u; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_originations
    ADD CONSTRAINT subscription_checkout_originations_gateway_checkout_reference_u UNIQUE (gateway, checkout_reference);


--
-- Name: subscription_checkout_originations subscription_checkout_originations_gateway_provider_subscriptio; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_originations
    ADD CONSTRAINT subscription_checkout_originations_gateway_provider_subscriptio UNIQUE (gateway, provider_subscription_id);


--
-- Name: subscription_checkout_originations subscription_checkout_originations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_originations
    ADD CONSTRAINT subscription_checkout_originations_pkey PRIMARY KEY (id);


--
-- Name: subscription_checkout_originations subscription_checkout_originations_tenant_uuid_idempotency_key_; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_originations
    ADD CONSTRAINT subscription_checkout_originations_tenant_uuid_idempotency_key_ UNIQUE (tenant_uuid, idempotency_key);


--
-- Name: subscription_checkout_originations subscription_checkout_originations_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_originations
    ADD CONSTRAINT subscription_checkout_originations_uuid_unique UNIQUE (uuid);


--
-- Name: subscription_checkout_subject_guards subscription_checkout_subject_guards_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_subject_guards
    ADD CONSTRAINT subscription_checkout_subject_guards_pkey PRIMARY KEY (id);


--
-- Name: subscription_checkout_subject_guards subscription_checkout_subject_guards_tenant_uuid_subject_key_un; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_subject_guards
    ADD CONSTRAINT subscription_checkout_subject_guards_tenant_uuid_subject_key_un UNIQUE (tenant_uuid, subject_key);


--
-- Name: subscription_checkout_subject_guards subscription_checkout_subject_guards_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subscription_checkout_subject_guards
    ADD CONSTRAINT subscription_checkout_subject_guards_uuid_unique UNIQUE (uuid);
...
--
-- Name: commerce_download_grants uniq_grant_order_download; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_download_grants
    ADD CONSTRAINT uniq_grant_order_download UNIQUE (order_uuid, download_uuid);


--
-- Name: commerce_download_grants uniq_grant_token_hash; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commerce_download_grants
    ADD CONSTRAINT uniq_grant_token_hash UNIQUE (token_hash);
...
--
-- Name: billing_plans_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX billing_plans_tenant_uuid_index ON public.billing_plans USING btree (tenant_uuid);
...
--
-- Name: commerce_attribute_values_attribute_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_attribute_values_attribute_uuid_index ON public.commerce_attribute_values USING btree (attribute_uuid);


--
-- Name: commerce_attributes_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_attributes_tenant_uuid_index ON public.commerce_attributes USING btree (tenant_uuid);


--
-- Name: commerce_carts_tenant_uuid_user_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_carts_tenant_uuid_user_uuid_index ON public.commerce_carts USING btree (tenant_uuid, user_uuid);


--
-- Name: commerce_categories_parent_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_categories_parent_uuid_index ON public.commerce_categories USING btree (parent_uuid);


--
-- Name: commerce_categories_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_categories_tenant_uuid_index ON public.commerce_categories USING btree (tenant_uuid);


--
-- Name: commerce_chargeback_lines_tenant_seller_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_chargeback_lines_tenant_seller_index ON public.commerce_chargeback_lines USING btree (tenant_uuid, seller_uuid);


--
-- Name: commerce_chargebacks_tenant_order_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_chargebacks_tenant_order_index ON public.commerce_chargebacks USING btree (tenant_uuid, order_uuid);


--
-- Name: commerce_chargebacks_tenant_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_chargebacks_tenant_status_index ON public.commerce_chargebacks USING btree (tenant_uuid, status);


--
-- Name: commerce_commission_events_subject_created_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_commission_events_subject_created_index ON public.commerce_commission_policy_events USING btree (tenant_uuid, subject_kind, subject_uuid, created_at);


--
-- Name: commerce_customer_addresses_tenant_uuid_user_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_customer_addresses_tenant_uuid_user_uuid_index ON public.commerce_customer_addresses USING btree (tenant_uuid, user_uuid);


--
-- Name: commerce_download_grants_blob_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_download_grants_blob_uuid_index ON public.commerce_download_grants USING btree (blob_uuid);


--
-- Name: commerce_download_grants_order_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_download_grants_order_uuid_index ON public.commerce_download_grants USING btree (order_uuid);


--
-- Name: commerce_download_grants_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_download_grants_tenant_uuid_index ON public.commerce_download_grants USING btree (tenant_uuid);


--
-- Name: commerce_downloads_blob_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_downloads_blob_uuid_index ON public.commerce_downloads USING btree (blob_uuid);


--
-- Name: commerce_downloads_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_downloads_tenant_uuid_index ON public.commerce_downloads USING btree (tenant_uuid);


--
-- Name: commerce_downloads_variant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_downloads_variant_uuid_index ON public.commerce_downloads USING btree (variant_uuid);


--
-- Name: commerce_ledger_account_key_currency_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_ledger_account_key_currency_index ON public.commerce_marketplace_ledger USING btree (tenant_uuid, account_key, currency);


--
-- Name: commerce_ledger_account_kind_seller_currency_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_ledger_account_kind_seller_currency_index ON public.commerce_marketplace_ledger USING btree (tenant_uuid, account_kind, seller_uuid, currency);


--
-- Name: commerce_marketplace_ledger_chargeback_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_marketplace_ledger_chargeback_uuid_index ON public.commerce_marketplace_ledger USING btree (chargeback_uuid);


--
-- Name: commerce_marketplace_ledger_order_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_marketplace_ledger_order_uuid_index ON public.commerce_marketplace_ledger USING btree (order_uuid);


--
-- Name: commerce_marketplace_ledger_payout_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_marketplace_ledger_payout_uuid_index ON public.commerce_marketplace_ledger USING btree (payout_uuid);


--
-- Name: commerce_marketplace_ledger_refund_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_marketplace_ledger_refund_uuid_index ON public.commerce_marketplace_ledger USING btree (refund_uuid);


--
-- Name: commerce_marketplace_ledger_reserve_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_marketplace_ledger_reserve_uuid_index ON public.commerce_marketplace_ledger USING btree (reserve_uuid);


--
-- Name: commerce_order_events_order_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_order_events_order_uuid_index ON public.commerce_order_events USING btree (order_uuid);


--
-- Name: commerce_order_lines_order_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_order_lines_order_uuid_index ON public.commerce_order_lines USING btree (order_uuid);


--
-- Name: commerce_order_lines_order_uuid_seller_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_order_lines_order_uuid_seller_uuid_index ON public.commerce_order_lines USING btree (order_uuid, seller_uuid);


--
-- Name: commerce_orders_tenant_uuid_created_at_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_orders_tenant_uuid_created_at_index ON public.commerce_orders USING btree (tenant_uuid, created_at);


--
-- Name: commerce_orders_tenant_uuid_placed_at_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_orders_tenant_uuid_placed_at_index ON public.commerce_orders USING btree (tenant_uuid, placed_at);


--
-- Name: commerce_orders_tenant_uuid_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_orders_tenant_uuid_status_index ON public.commerce_orders USING btree (tenant_uuid, status);


--
-- Name: commerce_orders_tenant_uuid_user_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_orders_tenant_uuid_user_uuid_index ON public.commerce_orders USING btree (tenant_uuid, user_uuid);


--
-- Name: commerce_payment_links_issued_session_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_payment_links_issued_session_index ON public.commerce_payment_links USING btree (tenant_uuid, provider_session_issued_at, order_uuid);


--
-- Name: commerce_payment_links_order_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_payment_links_order_status_index ON public.commerce_payment_links USING btree (tenant_uuid, order_uuid, status);


--
-- Name: commerce_payout_accounts_tenant_seller_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_payout_accounts_tenant_seller_index ON public.commerce_seller_payout_accounts USING btree (tenant_uuid, seller_uuid);


--
-- Name: commerce_payouts_status_next_attempt_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_payouts_status_next_attempt_index ON public.commerce_payouts USING btree (tenant_uuid, status, next_attempt_at);


--
-- Name: commerce_payouts_status_next_reconcile_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_payouts_status_next_reconcile_index ON public.commerce_payouts USING btree (tenant_uuid, status, next_reconcile_at);


--
-- Name: commerce_payouts_tenant_uuid_seller_uuid_currency_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_payouts_tenant_uuid_seller_uuid_currency_index ON public.commerce_payouts USING btree (tenant_uuid, seller_uuid, currency);


--
-- Name: commerce_product_addons_product_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_addons_product_uuid_index ON public.commerce_product_addons USING btree (product_uuid);


--
-- Name: commerce_product_addons_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_addons_tenant_uuid_index ON public.commerce_product_addons USING btree (tenant_uuid);


--
-- Name: commerce_product_attributes_product_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_attributes_product_uuid_index ON public.commerce_product_attributes USING btree (product_uuid);


--
-- Name: commerce_product_categories_category_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_categories_category_uuid_index ON public.commerce_product_categories USING btree (category_uuid);


--
-- Name: commerce_product_categories_product_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_categories_product_uuid_index ON public.commerce_product_categories USING btree (product_uuid);


--
-- Name: commerce_product_children_child_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_children_child_uuid_index ON public.commerce_product_children USING btree (child_uuid);


--
-- Name: commerce_product_children_product_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_children_product_uuid_index ON public.commerce_product_children USING btree (product_uuid);


--
-- Name: commerce_product_media_product_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_media_product_uuid_index ON public.commerce_product_media USING btree (product_uuid);


--
-- Name: commerce_product_media_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_media_tenant_uuid_index ON public.commerce_product_media USING btree (tenant_uuid);


--
-- Name: commerce_product_tags_product_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_tags_product_uuid_index ON public.commerce_product_tags USING btree (product_uuid);


--
-- Name: commerce_product_tags_tag_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_product_tags_tag_uuid_index ON public.commerce_product_tags USING btree (tag_uuid);


--
-- Name: commerce_products_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_products_status_index ON public.commerce_products USING btree (status);


--
-- Name: commerce_products_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_products_tenant_uuid_index ON public.commerce_products USING btree (tenant_uuid);


--
-- Name: commerce_products_tenant_uuid_seller_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_products_tenant_uuid_seller_uuid_index ON public.commerce_products USING btree (tenant_uuid, seller_uuid);


--
-- Name: commerce_refund_lines_refund_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_refund_lines_refund_uuid_index ON public.commerce_refund_lines USING btree (refund_uuid);


--
-- Name: commerce_refunds_order_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_refunds_order_uuid_index ON public.commerce_refunds USING btree (order_uuid);


--
-- Name: commerce_refunds_tenant_uuid_completed_at_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_refunds_tenant_uuid_completed_at_index ON public.commerce_refunds USING btree (tenant_uuid, completed_at);


--
-- Name: commerce_refunds_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_refunds_tenant_uuid_index ON public.commerce_refunds USING btree (tenant_uuid);


--
-- Name: commerce_reserve_events_subject_created_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_reserve_events_subject_created_index ON public.commerce_reserve_policy_events USING btree (tenant_uuid, subject_kind, subject_uuid, created_at);


--
-- Name: commerce_reviews_product_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_reviews_product_uuid_index ON public.commerce_reviews USING btree (product_uuid);


--
-- Name: commerce_reviews_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_reviews_tenant_uuid_index ON public.commerce_reviews USING btree (tenant_uuid);


--
-- Name: commerce_seller_api_key_credentials_lineage_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_api_key_credentials_lineage_index ON public.commerce_seller_api_key_credentials USING btree (tenant_uuid, lineage_uuid);


--
-- Name: commerce_seller_api_key_credentials_lineage_rel_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_api_key_credentials_lineage_rel_index ON public.commerce_seller_api_key_credentials USING btree (tenant_uuid, lineage_uuid, relationship);


--
-- Name: commerce_seller_api_key_events_action_created_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_api_key_events_action_created_index ON public.commerce_seller_api_key_events USING btree (action, created_at);


--
-- Name: commerce_seller_api_key_events_seller_created_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_api_key_events_seller_created_index ON public.commerce_seller_api_key_events USING btree (tenant_uuid, seller_uuid, created_at);


--
-- Name: commerce_seller_api_keys_seller_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_api_keys_seller_status_index ON public.commerce_seller_api_keys USING btree (tenant_uuid, seller_uuid, status);


--
-- Name: commerce_seller_lifecycle_events_seller_created_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_lifecycle_events_seller_created_index ON public.commerce_seller_lifecycle_events USING btree (tenant_uuid, seller_uuid, created_at);


--
-- Name: commerce_seller_memberships_seller_uuid_status_role_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_memberships_seller_uuid_status_role_index ON public.commerce_seller_memberships USING btree (seller_uuid, status, role);


--
-- Name: commerce_seller_memberships_tenant_uuid_user_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_memberships_tenant_uuid_user_uuid_index ON public.commerce_seller_memberships USING btree (tenant_uuid, user_uuid);


--
-- Name: commerce_seller_orders_confirmed_listing_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_orders_confirmed_listing_index ON public.commerce_seller_orders USING btree (tenant_uuid, seller_uuid, confirmed_at, fulfillment_status);


--
-- Name: commerce_seller_orders_order_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_orders_order_uuid_index ON public.commerce_seller_orders USING btree (order_uuid);


--
-- Name: commerce_seller_reserves_fifo_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_reserves_fifo_index ON public.commerce_seller_reserves USING btree (tenant_uuid, seller_uuid, currency, status, release_at);


--
-- Name: commerce_seller_reserves_status_release_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_reserves_status_release_index ON public.commerce_seller_reserves USING btree (tenant_uuid, status, release_at);


--
-- Name: commerce_seller_webhook_deliveries_endpoint_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_webhook_deliveries_endpoint_status_index ON public.commerce_seller_webhook_deliveries USING btree (tenant_uuid, endpoint_uuid, status);


--
-- Name: commerce_seller_webhook_deliveries_event_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_webhook_deliveries_event_index ON public.commerce_seller_webhook_deliveries USING btree (tenant_uuid, webhook_event_uuid);


--
-- Name: commerce_seller_webhook_deliveries_status_claim_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_webhook_deliveries_status_claim_index ON public.commerce_seller_webhook_deliveries USING btree (tenant_uuid, status, claim_expires_at);


--
-- Name: commerce_seller_webhook_deliveries_status_next_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_webhook_deliveries_status_next_index ON public.commerce_seller_webhook_deliveries USING btree (tenant_uuid, status, next_attempt_at);


--
-- Name: commerce_seller_webhook_endpoint_events_endpoint_created_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_webhook_endpoint_events_endpoint_created_index ON public.commerce_seller_webhook_endpoint_events USING btree (tenant_uuid, endpoint_uuid, created_at);


--
-- Name: commerce_seller_webhook_endpoints_seller_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_webhook_endpoints_seller_status_index ON public.commerce_seller_webhook_endpoints USING btree (tenant_uuid, seller_uuid, status);


--
-- Name: commerce_seller_webhook_events_seller_created_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_webhook_events_seller_created_index ON public.commerce_seller_webhook_events USING btree (tenant_uuid, seller_uuid, created_at);


--
-- Name: commerce_seller_webhook_secrets_endpoint_rel_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_seller_webhook_secrets_endpoint_rel_index ON public.commerce_seller_webhook_secrets USING btree (tenant_uuid, endpoint_uuid, relationship);


--
-- Name: commerce_sellers_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_sellers_tenant_uuid_index ON public.commerce_sellers USING btree (tenant_uuid);


--
-- Name: commerce_shipping_classes_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_shipping_classes_tenant_uuid_index ON public.commerce_shipping_classes USING btree (tenant_uuid);


--
-- Name: commerce_shipping_methods_zone_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_shipping_methods_zone_uuid_index ON public.commerce_shipping_methods USING btree (zone_uuid);


--
-- Name: commerce_shipping_zone_locations_zone_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_shipping_zone_locations_zone_uuid_index ON public.commerce_shipping_zone_locations USING btree (zone_uuid);


--
-- Name: commerce_shipping_zones_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_shipping_zones_tenant_uuid_index ON public.commerce_shipping_zones USING btree (tenant_uuid);


--
-- Name: commerce_stock_movements_tenant_uuid_variant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_stock_movements_tenant_uuid_variant_uuid_index ON public.commerce_stock_movements USING btree (tenant_uuid, variant_uuid);


--
-- Name: commerce_tags_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_tags_tenant_uuid_index ON public.commerce_tags USING btree (tenant_uuid);


--
-- Name: commerce_tax_rates_tenant_uuid_country_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_tax_rates_tenant_uuid_country_index ON public.commerce_tax_rates USING btree (tenant_uuid, country);


--
-- Name: commerce_tax_rates_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_tax_rates_tenant_uuid_index ON public.commerce_tax_rates USING btree (tenant_uuid);


--
-- Name: commerce_variants_product_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_variants_product_uuid_index ON public.commerce_variants USING btree (product_uuid);


--
-- Name: commerce_variants_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_variants_tenant_uuid_index ON public.commerce_variants USING btree (tenant_uuid);


--
-- Name: commerce_wishlist_items_tenant_user_position_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX commerce_wishlist_items_tenant_user_position_index ON public.commerce_wishlist_items USING btree (tenant_uuid, user_uuid, "position");
...
--
-- Name: gateway_subscriptions_billing_plan_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX gateway_subscriptions_billing_plan_uuid_index ON public.gateway_subscriptions USING btree (billing_plan_uuid);


--
-- Name: gateway_subscriptions_gateway_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX gateway_subscriptions_gateway_status_index ON public.gateway_subscriptions USING btree (gateway, status);


--
-- Name: gateway_subscriptions_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX gateway_subscriptions_tenant_uuid_index ON public.gateway_subscriptions USING btree (tenant_uuid);
...
--
-- Name: idx_provider_events_dispatch; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_provider_events_dispatch ON public.provider_events USING btree (status, dispatch_status, dispatch_claimed_at);
...
--
-- Name: invoices_billing_plan_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX invoices_billing_plan_uuid_index ON public.invoices USING btree (billing_plan_uuid);


--
-- Name: invoices_due_at_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX invoices_due_at_index ON public.invoices USING btree (due_at);


--
-- Name: invoices_payable_type_payable_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX invoices_payable_type_payable_id_index ON public.invoices USING btree (payable_type, payable_id);
...
--
-- Name: invoices_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX invoices_tenant_uuid_index ON public.invoices USING btree (tenant_uuid);


--
-- Name: invoices_user_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX invoices_user_uuid_index ON public.invoices USING btree (user_uuid);
...
--
-- Name: payment_intents_gateway_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payment_intents_gateway_index ON public.payment_intents USING btree (gateway);


--
-- Name: payment_intents_payable_type_payable_id_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payment_intents_payable_type_payable_id_status_index ON public.payment_intents USING btree (payable_type, payable_id, status);


--
-- Name: payment_intents_reference_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payment_intents_reference_index ON public.payment_intents USING btree (reference);


--
-- Name: payment_intents_tenant_uuid_gateway_reference_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX payment_intents_tenant_uuid_gateway_reference_unique ON public.payment_intents USING btree (tenant_uuid, gateway, reference);


--
-- Name: payment_intents_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payment_intents_tenant_uuid_index ON public.payment_intents USING btree (tenant_uuid);


--
-- Name: payments_gateway_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payments_gateway_index ON public.payments USING btree (gateway);
...
--
-- Name: payments_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payments_tenant_uuid_index ON public.payments USING btree (tenant_uuid);


--
-- Name: payments_user_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payments_user_uuid_index ON public.payments USING btree (user_uuid);


--
-- Name: payvia_transfers_tenant_uuid_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX payvia_transfers_tenant_uuid_index ON public.payvia_transfers USING btree (tenant_uuid);
...
--
-- Name: provider_events_dispatch_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX provider_events_dispatch_status_index ON public.provider_events USING btree (dispatch_status);


--
-- Name: provider_events_gateway_logical_event_key_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX provider_events_gateway_logical_event_key_index ON public.provider_events USING btree (gateway, logical_event_key);


--
-- Name: provider_events_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX provider_events_status_index ON public.provider_events USING btree (status);
...
--
-- Name: subscription_checkout_originations_status_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX subscription_checkout_originations_status_index ON public.subscription_checkout_originations USING btree (status);


--
-- Name: subscription_checkout_originations_subject_key_live_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX subscription_checkout_originations_subject_key_live_index ON public.subscription_checkout_originations USING btree (subject_key, live);


--
-- Name: subscription_checkout_subject_guards_state_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX subscription_checkout_subject_guards_state_index ON public.subscription_checkout_subject_guards USING btree (state);
...
CREATE UNIQUE INDEX uniq_entry_schema_migrations_active ON public.entry_schema_migrations USING btree (content_type_uuid) WHERE ((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('running'::character varying)::text]));
...
\unrestrict j4JIttt0ejMr6TBgKK5qaLCDWqMg2TbAqJr7AaV5ZIlIBIwgSx5fiIAkj7iCZ4A
