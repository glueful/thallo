...
final class ListingArchivePagesTest extends AppTestCase
{
    ...
    public function testPaginationPathsAndDistinctCacheEntries(): void
    {
        ...
        self::assertIsArray($this->cache()->get('render:default:blue-slate-round-sans-plain:%2Fpost'));
        self::assertIsArray($this->cache()->get('render:default:blue-slate-round-sans-plain:%2Fpost%2Fpage%2F2'));
    ...
    public function testNewPublishPurgesCachedListingViaTheBroadTypeTag(): void
    {
        ...
        self::assertNull(
            $this->cache()->get('render:default:blue-slate-round-sans-plain:%2Fpost%2Fpage%2F2'),
