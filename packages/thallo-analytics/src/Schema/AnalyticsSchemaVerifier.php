...
namespace Thallo\Analytics\Schema;

use Glueful\Database\Connection;
use Glueful\Extensions\Schema\StructuralVerifierInterface;

/**
 * Structural verifier for glueful/thallo-analytics (schema policy spec B7): create migrations prove the
 ...
 */
final class AnalyticsSchemaVerifier implements StructuralVerifierInterface
{
    /** @var array<string, list<string>> create migration => every table it creates */
    private const CREATED_TABLES = [
        '001_CreateAnalyticsFactsTable.php' => ['analytics_facts'],
        '002_CreateAnalyticsDailyTable.php' => ['analytics_daily'],
        '003_CreateAnalyticsActiveActorsTable.php' => ['analytics_active_actors'],
    ];

    /** @var array<string, list<string>> seed migration => permission slugs it guarantees */
    private const SEEDED_SLUGS = [
        '004_SeedAnalyticsPermissions.php' => ['analytics.read'],
    ];

    public function source(): string
    {
        return 'glueful/thallo-analytics';
    }
